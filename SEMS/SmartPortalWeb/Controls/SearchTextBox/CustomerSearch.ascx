<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomerSearch.ascx.cs" Inherits="Controls_SearchTextBox_Customer" %>
...
<div class="dropdown-search">
    <asp:UpdatePanel runat="server">
        ...
        <ContentTemplate>
                ...
                <asp:HiddenField runat="server" ID="hdfCustomerSearchValue" />
                <asp:HiddenField runat="server" ID="hdfCustomerSearchText" />

                <button type="button" runat="server" id="btnPopup" class="search-popup" style="background: transparent; border: none; box-shadow: none"
                    data-toggle="modal" data-target="#UserCode"> <img src="/Images/icon/search.png" />
                </button>
        </ContentTemplate>
    </asp:UpdatePanel>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover footable c_list">
                                                <thead class="thead-light">
                                                    <tr>
                                                        <th>
                                                            <input name='<%="item"+UserCode.ClientID%>' data-control='<%=hdID.ClientID %>' data-display='<%=hdfCustomerSearchText.ClientID %>' style="visibility: hidden" type="checkbox" onclick="CheckboxAll(this)">
                                                        </th>
