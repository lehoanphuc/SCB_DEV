<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSWithdrawalWalletConsumer_Widget" %>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-hdr">
                        <h2>
                            <%=Resources.labels.WithdrawalEWalletConsumer%>
                        </h2>
                    </div>
                    <div>
                    ...
                    <div class="panel-container">
                            ...
                            <asp:Panel ID="pnAdd" runat="server">
                                <div class="row">
                                    <div class="col-sm-7">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label required"><%=Resources.labels.WithdrawalAmount%></label>
                                            <div class="col-sm-8">
                                                <asp:TextBox ID="txtWithdrawalAmount" MaxLength="18" runat="server" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label"><%=Resources.labels.FeeAmount%> </label>
                                            <div class="col-sm-8">
                                                <asp:TextBox ID="txtFeeAmount" Enabled="false" runat="server" MaxLength="18" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="panel-content div-btn rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted">
                            ...
                            <asp:Button ID="btnPrint" Enabled="false" CssClass="btn btn-primary" runat="server" Text="<%$ Resources:labels, print %> " OnClientClick="javascript:return poponload()" />
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    function poponload() {
        ...
        testwindow = window.open("widgets/SEMSWithdrawalEWalletConsumer/print.aspx?ID=" + txref + '&' + "cul=" + '<%=System.Globalization.CultureInfo.CurrentCulture.ToString()%>', "BienLai", "menubar=1,scrollbars=1,width=500,height=650");
