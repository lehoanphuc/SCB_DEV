...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <div id="divToolbar" runat="server" visible="false">
                    ...
                    <asp:Repeater runat="server" ID="rptData" OnItemDataBound="rptData_OnItemDataBound" OnItemCommand="rptData_ItemCommand">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" style="border: 1px solid rgba(0, 0, 0, 0.1); border-style: Solid;">
                                    <thead style="background-color: #7A58BF; color: #FFF;">
                                        <tr>
                                             <th class="title-repeater">Request ID</th>
                                            ...
                                            <th class="title-repeater">Customer Type</th>
                                            <th class="title-repeater">Account Type</th>
                                            <th class="title-repeater">Currency</th>
                                            <th class="title-repeater"><%=Resources.labels.KycLevel%></th>
                                            <th class="title-repeater"><%=Resources.labels.status%></th>
                                            <th class="title-repeater hidden"><%=Resources.labels.ProfileStatus%></th>
                                            <th class="title-repeater"><%=Resources.labels.DateCreate%></th>
                                            <th class="title-repeater hidden"><%=Resources.labels.edit%></th>
                                            <th class="title-repeater"><%=Resources.labels.approve%></th>
                                             <th class="title-repeater"><%=Resources.labels.reject%></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="tr-boder"><%#Eval("CUSTYPE") %></td>
                                <td class="tr-boder"><%#Eval("ACCTYPE") %></td>
                                <td class="tr-boder"><%#Eval("CCYID") %></td>
                                <td class="tr-boder"><%#Eval("KYCNAME")%></td>
                                <td class="tr-boder"><%#Eval("STS_OPENBANK") %></td>
                                <td class="tr-boder" hidden><%#Eval("PROFILE_STATUS") %></td>
                                <td class="tr-boder"><%#Eval("DATECREATED") %></td>
                                <td class="action tr-boder" style="text-align: center;" hidden>
                                    <asp:LinkButton ID="lbtnEdit" runat="server" Visible="false" class="btn btn-primary" CommandArgument='<%#Eval("RequestID")%>' CommandName='<%#IPC.ACTIONPAGE.EDIT%>'> <%=Resources.labels.edit%> </asp:LinkButton>
                                </td>
                                <td class="action tr-boder" style="text-align: center;">
                                  ...
                                  <td class="action tr-boder" style="text-align: center;">
                                    <asp:LinkButton ID="btnReject" runat="server" class="btn btn-secondary" CommandArgument='<%#Eval("RequestID")%>' CommandName='<%#IPC.ACTIONPAGE.REJECT%>'> <%=Resources.labels.reject%> </asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
