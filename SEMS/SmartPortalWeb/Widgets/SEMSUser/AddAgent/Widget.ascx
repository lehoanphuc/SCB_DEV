<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSUser_AddAgent_Widget" %>
    ...
    <ContentTemplate>
                        ...
                        <div class="panel-content form-horizontal p-b-0">
                            <asp:Panel ID="pnAdd" runat="server">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6" runat="server" id="divagentname">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label"><%=Resources.labels.localfullname %></label>
                                            <div class="col-sm-8">
                                                <asp:TextBox ID="txtLocalFullName" CssClass="form-control" placeholder="<%$ Resources:labels, localfullname %>" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <asp:DropDownList ID="ddlUserType" runat="server" OnSelectedIndexChanged="ddlUserType_SelectedIndexChanged" Enabled="false"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <asp:DropDownList ID="ddlAccountQT" CssClass="form-control select2 infinity" Width="100%" runat="server" AutoPostBack="True"
                                                    OnSelectedIndexChanged="ddlAccountQT_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="form-group" runat="server">
                                                                <div class="col-sm-10">
                                                                    <asp:TextBox ID="txtUserNameMB" onkeypress="return isKey(event)" runat="server" CssClass="form-control " ClientIDMode="Static" MaxLength="50" AutoPostBack="true" placeholder="User Name" Enabled="false" OnTextChanged="ChangePhoneAndUserName_Click"></asp:TextBox>
        ...
        <div style="text-align: center; padding-top: 10px;">
            <asp:Button ID="btsaveandcont" runat="server" CssClass="btn btn-primary" Text="<%$ Resources:labels, save %>"
                OnClick="btsaveandcont_Click" Visible="false"/>
            &nbsp;
