<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSUserOTP_Delete_Widget" %>
...
<div id="divCustHeader">
    ...
    <%=Resources.labels.xoathongtinotp %>
</div>
            ...
            <tr>
                <td align="center" class="style2">
                    <asp:Label ID="Label1" runat="server"
                        Text="<%$ Resources:labels, banchacchanmuonxoathongtinotpkhong %>"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
        ...
        <div class="content">
            <div style="padding-top: 10px; padding-bottom: 10px; text-align: center;">
                <asp:Label ID="lbresult" runat="server" ForeColor="Red" Font-Bold="true"
                    Text="<%$ Resources:labels, huythongtinotpthanhcong %>"></asp:Label>
            </div>
        </div>
    </div>
</asp:Panel>
