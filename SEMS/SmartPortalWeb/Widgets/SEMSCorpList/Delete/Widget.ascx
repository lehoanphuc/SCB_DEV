<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSCustomerListCorp_Delete_Widget" %>
...
<div id="divCustHeader">
    <img alt="" src="widgets/SEMSContractList/Images/messenger.png" style="width: 40px; height: 32px; margin-bottom:10px;" align="middle" /> 
    XÓA KHÁCH HÀNG
        ...
        <tr>
            <td align="center" class="style2">
                <asp:Label ID="Label1" runat="server" 
                    Text="Bạn chắc chắn muốn xóa khách hàng không?"></asp:Label>
            </td>
