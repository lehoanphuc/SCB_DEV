                            ...
                            <asp:Panel ID="pnRegion" runat="server">
                                <div class="row">
                                    <div class="form-group col-xs-12">
                                        <label class="col-sm-2 col-xs-12 col-sm-offset-2 control-label"><%= Resources.labels.mavungphi %> </label>
                                        <div class="col-sm-4 col-xs-12">
                                            <asp:TextBox ID="txRegionID" Enabled="False" CssClass="form-control" runat="server"/>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-xs-12">
                                        <label class="col-sm-2 col-xs-12 col-sm-offset-2 control-label required"><%= Resources.labels.mavung %></label>
                                        <div class="col-sm-4 col-xs-12">
                                            <asp:TextBox ID="txtRegionCode" Enabled="True" CssClass="form-control" runat="server" MaxLength="50"/>
                                        </div>
                                        <div class="col-sm-4 col-xs-12"></div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-xs-12">
                                        <label class="col-sm-2 col-xs-12 col-sm-offset-2 control-label required"><%= Resources.labels.kieumavung %> </label>
                                        <div class="col-sm-4 col-xs-12">
                                            <asp:DropDownList ID="ddlRegionType" CssClass="form-control select2" Width="100%" runat="server"/>
                                        </div>
                                        <div class="col-sm-4 col-xs-12"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-xs-12">
                                        <label class="col-sm-2 col-xs-12 col-sm-offset-2 control-label"><%= Resources.labels.countryname %> </label>
                                        <div class="col-sm-4 col-xs-12">
                                            <asp:DropDownList ID="ddlCountryId" CssClass="form-control select2" Width="100%" runat="server"/>
                                        </div>
                                        <div class="col-sm-4 col-xs-12"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-xs-12">
                                        <label class="col-sm-2 col-xs-12 col-sm-offset-2 control-label"><%= Resources.labels.order %> </label>
                                        <div class="col-sm-4 col-xs-12">
                                            <asp:DropDownList ID="ddlOrder" CssClass="form-control select2" Width="100%" runat="server"/>
                                        </div>
                                        <div class="col-sm-4 col-xs-12"></div>
                                    </div>
                                </div>
                                        ...
                                        <asp:GridView ID="gvBranchList" CssClass="table table-hover" runat="server" BackColor="White"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:labels, machinhanh %>">
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lblBranchCode" runat="server"/>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
...
<script type="text/javascript">
    var regionCode = '<%= txtRegionCode.ClientID %>';
    var regionFeeName = '<%= txRegionName.ClientID %>';

    function validate() {
      if(!validateEmpty(regionCode, '<%= Resources.labels.mavungkhongduocdetrong %>')){
