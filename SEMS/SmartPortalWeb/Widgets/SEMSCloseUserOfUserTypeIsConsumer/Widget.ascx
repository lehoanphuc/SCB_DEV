                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <asp:DropDownList ID="ddUserType" CssClass="form-control select2"  ReadOnly="true" AutoPostBack="true" OnSelectedIndexChanged="changeUserType_LoadInfo" runat="server"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="form-group">
