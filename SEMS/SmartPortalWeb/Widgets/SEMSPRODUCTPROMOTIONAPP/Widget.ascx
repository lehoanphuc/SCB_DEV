<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSProductPromotionApp_Widget" %>
    ...
    <ContentTemplate>
        <div class="subheader">
            <h1 class="subheader-title">
                <%=Resources.labels.productpromotionapprove %>
            </h1>
        </div>
        <div class="loading">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 col-xs-12">
                                                        <asp:DropDownList ID="ddlscheduleType" CssClass="form-control select2 infinity" runat="server">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
