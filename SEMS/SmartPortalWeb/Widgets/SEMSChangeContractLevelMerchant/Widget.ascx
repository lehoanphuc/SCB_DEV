<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSChangeContractLevelMerchant_Widget" %>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-hdr">
                        <h2>
                            <%=Resources.labels.ChangeContractLevelMerchant%>
                        </h2>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <asp:TextBox ID="txtPhoneNumber" CssClass="form-control" runat="server" IsRequired="true" OnTextChanged="loadInfo" AutoPostBack="true"></asp:TextBox>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label required"><%=Resources.labels.SourceWalletLevel%></label>
                                            <div class="col-sm-8">
                                                <asp:DropDownList ID="ddlSourceWalletLevel" CssClass="form-control select2" ReadOnly="true" runat="server"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label required"><%=Resources.labels.DestinationWalletLevel%></label>
                                            <div class="col-sm-8">
                                                <asp:DropDownList ID="ddlDestinationWalletLevel" CssClass="form-control select2" runat="server"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
