    ...
    <ContentTemplate>
        <div class="subheader">
            <h1 class="subheader-title">
               <%=Resources.labels.walletbalancelimit %>
            </h1>
        </div>
        <div id="divError">
        ...
        <div id="divSearch">
            <asp:Panel ID="pnSearch" class="panel-content form-horizontal p-b-0" runat="server" DefaultButton="btnSearch">
                
                     <div class="row" style="margin-left: 2%">
                            <div class="col-sm-5 col-xs-12">
                                <div class="form-group">
                                    <label class="col-sm-4 col-xs-12 control-label"><%=Resources.labels.contractlvlID %></label>
                        ...
                        <div class="row" style="margin-left: 2%">
                            <div class="col-sm-5 col-xs-12">
                                <div class="form-group">
                                    <label class="col-sm-4 col-xs-12 control-label"><%=Resources.labels.subusertype %></label>
                                    <div class="col-sm-8 col-xs-12">
                                    ...
                                    <table class="table table-hover footable c_list" style="margin-bottom: 0px">
                                        <thead class="thead-light repeater-table">
                                            <tr>
                                                ...
                                                <th class="title-repeater"><%=Resources.labels.subusertype%></th>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td class="tdcheck tr-boder item-center">
                                    <input name="item1" class="check" value="<%#Eval("ContractLevelID") + "+" + Eval("SubUserCode")%>" onclick="ConfigCheckbox(this)" type="checkbox">
                                </td>
                                <td class="tr-boder">
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("ContractLevelID") + "+" + Eval("SubUserCode")%>' CommandName='<%#IPC.ACTIONPAGE.DETAILS%>'><%#Eval("ContractLevelName")%></asp:LinkButton></td>
                                <td class="tr-boder"><%#Eval("SubUserType") %></td>
                                <td class="tr-boder"><%#Eval("CAPTION") %></td>
                                <td class="tr-boder item-center">
                                    <asp:LinkButton runat="server" class="btn btn-primary" CommandArgument='<%#Eval("ContractLevelID") + "+" + Eval("SubUserCode")%>' CommandName='<%#IPC.ACTIONPAGE.EDIT%>'><%=Resources.labels.edit%></asp:LinkButton>
                                </td>
                                <td class="tr-boder item-center">
                                    <asp:LinkButton runat="server" class="btn btn-secondary" CommandArgument='<%#Eval("ContractLevelID") + "+" + Eval("SubUserCode")%>' CommandName='<%#IPC.ACTIONPAGE.DELETE%>' OnClientClick="return ConfirmDelete('Are you sure you want to delete this entry?');"><%=Resources.labels.delete%></asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
