<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSContractManagement_Delete_Widget" %>
...
<div id="divCustHeader">
    <img alt="" src="widgets/SEMSFeeManagement/Images/tax.png" style="width: 30px; height: 32px; margin-bottom: 10px;" align="middle" />
    <%=Resources.labels.xoaphigiaodich %>
</div>
<div id="divError">
</div>
            ...
            <tr>
                <td align="center" class="style2">
                    <asp:Label ID="Label1" runat="server"
                        Text="<%$ Resources:labels, banchacchanmuonxoaphigiaodichkhong %>"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
        ...
        <table class="style1" cellspacing="0" cellpadding="5">
            <tr>
                <td align="center" class="style3">
                    <asp:Label runat="server" ID="lblError" ForeColor="Red" Text="<%$ Resources:labels, xoaphigiaodichthanhcong %>"></asp:Label>
                </td>
            </tr>
        </table>
    </div>
