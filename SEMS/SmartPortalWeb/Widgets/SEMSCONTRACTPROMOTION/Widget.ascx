<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSCONTRACTPROMOTIONManager_Widget" %>
    ...
    <ContentTemplate>
        <div class="subheader">
            <h1 class="subheader-title">
                <%=Resources.labels.contractpromotionnmanager %>
            </h1>
        </div>
        <div class="loading">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 col-xs-12">
                                                        <asp:DropDownList ID="ddlpromotiontype" CssClass="form-control select2 infinity" runat="server">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <asp:GridView ID="gvProductDiscount" CssClass="table table-hover" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:labels, contractno%>">
                        <ItemTemplate>
                            <asp:LinkButton ID="hpProductName" runat="server" CommandName='<%#IPC.ACTIONPAGE.DETAILS %>' CommandArgument='<%#Eval("PromotionID") %>' OnClientClick="Loading();"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField Visible="False" HeaderText="<%$ Resources:labels, promotiondesc %>">
                        <ItemTemplate>
