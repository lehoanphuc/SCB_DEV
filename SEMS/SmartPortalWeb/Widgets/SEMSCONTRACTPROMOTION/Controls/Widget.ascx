<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSContractDiscount_Controls_Widget" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
                        ...
                        <div class="panel-container">
                            <div class="panel-content form-horizontal p-b-0">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:TextBox runat="server" ID="txtContractNo" CssClass="form-control"  ></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-xs-12" runat="server" visible="False">
                                        <div class="form-group">
        ...
        <%--load list submerchant contract--%>
    <%--    <asp:Panel ID="pnSubContract" runat="server" Visible="False">
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <div class="panel">
                        <div class="panel-hdr">
                            <h2>
                                <%=Resources.labels.ListSubContract%>
                            </h2>
                        </div>
                        <div>
                            <asp:Literal runat="server" ID="ltrError"></asp:Literal>
                            <asp:GridView ID="gvListSubMerchantContract" CssClass="table table-hover" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                                Width="100%" AutoGenerateColumns="False" OnRowDataBound="gvListSubMerchantContract_OnRowDataBound" OnRowCommand="gvListSubMerchantContract_OnRowCommand">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="<%$ Resources:labels, phoneno %>">
                                        <ItemTemplate>
        ...
        <div class="panel-content div-btn rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted">
            ...
            <asp:Button ID="btClone" CssClass="btn btn-primary" runat="server" Text="<%$ Resources:labels, clone %>" OnClick="btClone_OnClick" OnClientClick="Loading();" />
