<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_Topup_Delete_Widget" %>
...
<div id="divCustHeader">
    <img alt="" src="widgets/SEMSContractLimit/Images/contractlimit.png" style="width: 40px; height: 32px; margin-bottom:10px;" align="middle" /> 
        ...
        <tr>
            <td align="center" class="style2">
                <asp:Label ID="Label1" runat="server" 
                    Text="<%$ Resources:labels, xoacardtopup %>"></asp:Label>
        ...
        <table class="style1" cellspacing="0" cellpadding="5">
            <tr>
                <td align="center" class="style3">
                 <asp:Label runat="server" ID="lblError" ForeColor="Red" Text="<%$ Resources:labels, xoatopupcardthanhcong%>"></asp:Label>
                </td>
...
&nbsp;
    <asp:Button ID="btback" runat="server" 
        Text="<%$ Resources:labels, back %>" onclick="btback_Click" /><%--PostBackUrl="javascript:history.go(-1)" --%>
    &nbsp; &nbsp;
</div>
<!--end-->
<%--</ContentTemplate>
