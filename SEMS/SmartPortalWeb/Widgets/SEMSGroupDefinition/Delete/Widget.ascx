<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSGroupDefinition_Delete_Widget" %>
<div class="subheader">
    <h1 class="subheader-title">
        <%=Resources.labels.groupDefinitionDelete %>
    </h1>
</div>
<div class="row">
    <div class="col-sm-12">
