        ...
        <div id="divSearch">
            <div class="subheader">
                <h1 class="subheader-title">
                    <%=Resources.labels.FeeShareDefinition %>
                </h1>
            </div>
                                ...
                                <div class="collapse in" id="AdvanceSearch">
                                    <div class="panel-content form-horizontal p-b-0" style="display: block;">
                                        <div class="row" style="margin-left: 2%">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label"><%=Resources.labels.FeeShareName %></label>
                                                    <div class="col-sm-8">
                                                        <asp:TextBox ID="txtFeeShareName"  MaxLength="200" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </div>
                                         ...
                                         <div class="row" style="margin-left: 2%">
                                            <div class="col-sm-5">
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label"><%=Resources.labels.loaigiaodich %></label>
                                                    <div class="col-sm-8">
                ...
                <asp:Panel ScrollBars="Auto" runat="server">
                    ...
                    <asp:Repeater runat="server" ID="rptData" OnItemCommand="rptData_ItemCommand">
                        ...
                        <ItemTemplate>
                            <tr>
                                <td class="tr-boder">
                                    <input name="item1" class="check" value="<%#Eval("FeeShareID")%>" onclick="ConfigCheckbox(this)" type="checkbox">
                                </td>
                                <td class="action tr-boder">
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("FeeShareID")%>' CommandName='<%#IPC.ACTIONPAGE.DETAILS%>' OnClientClick="Loading();"><%#Eval("FeeShareCode") %></asp:LinkButton>
                                </td>
                                <td class="tr-boder"><%#Eval("FeeShareName") %></td>
                                 <td class="tr-boder"><%#Eval("TransactionTypeCaption") %></td>
                               
                                <td class="tr-boder" style="align-content:center">
                                    <asp:LinkButton runat="server" class="btn btn-primary" CommandArgument='<%#Eval("FeeShareID")%>' CommandName='<%#IPC.ACTIONPAGE.EDIT%>'>Edit</asp:LinkButton>
                                </td>
                                <td class="tr-boder">
                                    <asp:LinkButton runat="server" class="btn btn-secondary" CommandArgument='<%#Eval("FeeShareID")%>' CommandName='<%#IPC.ACTIONPAGE.DELETE%>' OnClientClick="return ConfirmDelete('Are you sure you want to delete this entry?');">Delete</asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
