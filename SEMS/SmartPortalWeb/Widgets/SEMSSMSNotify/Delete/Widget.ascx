...
<div id="divCustHeader">
    <img alt="" src="widgets/SEMSProduct/Images/product.png" style="width: 30px; height: 32px; margin-bottom:10px;" align="middle" /> 
   <%=Resources.labels.xoasanpham %>
        ...
        <tr>
            <td align="center" class="style2">
                <asp:Label ID="Label1" runat="server" 
                    Text="<%$ Resources:labels, banchacchanmuonxoasanpham %>"></asp:Label>
            </td>
