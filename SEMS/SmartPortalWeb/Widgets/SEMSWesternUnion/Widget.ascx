<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSWesternUnion_Widget" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <div class="subheader">
            <h1 class="subheader-title">Western Union
            </h1>
        </div>
        <div id="divError">
                                ...
                                <div class="row">
                                    <div class="col-sm-10 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 col-xs-12">
                                                        <asp:DropDownList ID="ddlStatus" CssClass="form-control select2 infinity" Width="100%" runat="server">
                                                            ...
                                                            <asp:ListItem Value="A" Text="Send"></asp:ListItem>
                                                            <asp:ListItem Value="D" Text="Cancel"></asp:ListItem>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="col-sm-4 col-xs-12 control-label">From Date</label>
                                                    <div class="col-sm-8 col-xs-12">
                                            ...
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="col-sm-4 col-xs-12 control-label">To Date</label>
                                                    <div class="col-sm-8 col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    <label class="col-sm-4 col-xs-12 control-label">Payout Country</label>
                                                    <div class="col-sm-8 col-xs-12">
                                                        <asp:DropDownList ID="ddlPayout" CssClass="form-control select2" Width="100%" runat="server">
                                                            <asp:ListItem Value="ALL" Text="<%$ Resources:labels, tatca %>"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                ...
                <asp:GridView ID="gvLTWA" CssClass="table table-hover white-space" runat="server"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="<%$ Resources:labels, sogiaodich%>">
                            <ItemTemplate>
                                <asp:LinkButton ID="lbTranID" runat="server" CommandName='<%#IPC.ACTIONPAGE.DETAILS %>' CommandArgument='<%#Eval("IPCTRANSID")%>'></asp:LinkButton>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Sender Amount"  >
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Sender Currency">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Receive Currency">
                            <ItemTemplate>
                                <asp:Label ID="lbReCCYID" runat="server"></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="gvHeader" />
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:LinkButton ID="hpEdit" runat="server" CssClass="btn btn-primary" CommandName='<%#IPC.ACTIONPAGE.EDIT %>' CommandArgument='<%#Eval("IPCTRANSID")%>'></asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText='Delete'>
                            <ItemTemplate>
                                <asp:LinkButton ID="hpDelete" runat="server" CssClass="btn btn-secondary" CommandName='<%#IPC.ACTIONPAGE.DELETE %>' CommandArgument='<%#Eval("IPCTRANSID")%>' OnClientClick="Loading(); return Confirm();">Cancel</asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                    </Columns>
