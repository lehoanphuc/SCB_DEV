...
public partial class Widgets_SEMSCountry_Widget : WidgetBase
{
    ...
    void BindData()
    {
        try
        {
            ...
            dtCountry = new SmartPortal.SEMS.Country().SearchCountryByCondition(
                    Utility.KillSqlInjection(txtcountryid.Text.Trim()),
                    Utility.KillSqlInjection(txtcountryname.Text.Trim()),
                    Utility.KillSqlInjection(txtcountrycode.Text.Trim()),
                    Utility.KillSqlInjection(txtCountryphone.Text.Trim()),
            ...
            if (dtCountry.Tables[0].Rows.Count > 0)
            {
                ...
                //{"Column 'TRECORDCOUNT' does not belong to table Table."}
            }
            else
            {
    ...
    protected void gvCountryList_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            CheckBox cbxSelect;
            Label lblCountrycode, lblCountryName, lblCountryphone, lblCurrency;
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                lblCountryphone = (Label)e.Row.FindControl("lblCountryphone");
                ...
                lblCountryphone.Text = drv["PhoneCountryCode"].ToString();
                lblCurrency.Text = drv["CurrencyID"].ToString();
    ...
    protected void gvCountryList_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            new SmartPortal.SEMS.Country().DeleteCountry(commandArg, ref IPCERRORCODE, ref IPCERRORDESC);
            if (IPCERRORCODE == "0")
            {
                BindData2();
        ...
        if (CheckPermitPageAction(IPC.ACTIONPAGE.DELETE))
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        new SmartPortal.SEMS.Country().DeleteCountry(CountryID[i], ref IPCERRORCODE, ref IPCERRORDESC);
