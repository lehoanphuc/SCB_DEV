<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSCountry_Widget" %>
                        ...
                        <div class="panel-content form-horizontal p-b-0">
                            <asp:Panel ID="pnSearch" runat="server" DefaultButton="btnSearch">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label"><%=Resources.labels.countryphone %></label>
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:TextBox ID="txtCountryphone" CssClass="form-control" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-2 col-xs-12">
        ...
        <div id="divResult" runat="server">
            ...
            <asp:GridView ID="gvCountryList" CssClass="table table-hover" runat="server" BackColor="White"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:labels, countryphone %>">
                        <ItemTemplate>
                            <asp:Label ID="lblCountryphone" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
