<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSFastBanking_Delete_Widget" %>
...
<div id="divCustHeader">
    <img alt="" src="widgets/SEMSATMSearch/Images/fastbank.png" style="width: 40px; height: 32px; margin-bottom:10px;" align="middle" />   
    <%=Resources.labels.xoashop%> 
        ...
        <table class="style1" cellspacing="0" cellpadding="5">
            <tr>
                <td align="center" class="style3">
                 <asp:Label runat="server" ID="lblError" ForeColor="Red" Text="<%$ Resources:labels, xoashopthanhcong %>"></asp:Label>
...
<div style="text-align:center; padding-top:10px;">
    <asp:Button ID="btsaveandcont" runat="server" onclick="btsaveandcont_Click" 
        Text="<%$ Resources:labels, luu %>" Width="71px" />
&nbsp;
