...
public partial class Widgets_SEMSCorpUserApprovalLimit_Widget : WidgetBase
{
    ...
    void BindData()
    {
        try
        {
            ...
            DataSet ds = new SmartPortal.SEMS.UserApprovalLimit().GetCMUserApprovalByCondition(Utility.KillSqlInjection(txtUserID.Text.Trim()),
            ...
            try
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < UserID.Length - 1; i++)
                    {
                        ...
                        new UserApprovalLimit().DeleteUserApprovalLimit(pos[0], pos[1], pos[2],ref IPCERRORCODE, ref IPCERRORDESC);
