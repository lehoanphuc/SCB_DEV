<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSCorpUserApprovalLimit_Controls_Widget" %>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-10 col-xs-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        <label class="col-sm-4 col-xs-12 control-label"><%=Resources.labels.approvallimit %></label>
                                                        <div class="col-sm-8 col-xs-12">
                                                ...
                                                <div class="col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        <label class="col-sm-4 col-xs-12 control-label"><%=Resources.labels.approvaltotallimitperday %></label>
                                                        <div class="col-sm-8 col-xs-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 col-xs-12">
                                                    <div class="form-group">
                                                        <label class="col-sm-4 col-xs-12 control-label"><%=Resources.labels.approvaltransperday %></label>
                                                        <div class="col-sm-8 col-xs-12">
...
<script type="text/javascript">
    ...
    function poponload() {
        testwindow = window.open("widgets/SEMSCorpUserApprovalLimit/print.aspx", "UserApprovalLimit",
