...
public partial class Widgets_Category_View_Widget : WidgetBase
{
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (Session["userName"] != null)
                {
                    if (Session["userName"].ToString().Trim() == drv["UserCreated"].ToString().Trim())
                    {
                        ...
                        hpEdit.NavigateUrl = SmartPortal.Common.Encrypt.EncryptURL(System.Configuration.ConfigurationManager.AppSettings["editcategory"] + "&catid=" + drv["CatID"].ToString());
                        ...
                        hpDelete.NavigateUrl = SmartPortal.Common.Encrypt.EncryptURL(System.Configuration.ConfigurationManager.AppSettings["deletecategory"] + "&catid=" + drv["CatID"].ToString());
    ...
    {
        Response.Redirect(SmartPortal.Common.Encrypt.EncryptURL(System.Configuration.ConfigurationManager.AppSettings["addcategory"]));
    }
    protected void lbDeleteSelected_Click(object sender, EventArgs e)
    {
        ...
        {
            SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["sysec"], "Widgets_Category_View_Widget", "lbDeleteSelected_Click", ex.ToString(), Request.Url.Query);
            SmartPortal.Common.Log.GoToErrorPage(System.Configuration.ConfigurationManager.AppSettings["sysec"], Request.Url.Query);
        }
        if (catID != "")
        {
            ...
            Response.Redirect(SmartPortal.Common.Encrypt.EncryptURL(System.Configuration.ConfigurationManager.AppSettings["deletecategory"]));
        }
        else
        {
            BindData();
