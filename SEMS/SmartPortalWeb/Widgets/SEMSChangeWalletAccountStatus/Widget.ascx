<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSChangeWalletAccountStatus_Widget" %>
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-hdr">
                <h2>
                    <%=Resources.labels.ChangeWalletAccountStatus%>
                </h2>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <asp:TextBox ID="txtPhoneNumber" CssClass="form-control" runat="server" OnTextChanged="load_info" AutoPostBack="true"></asp:TextBox>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-5 control-label required"><%=Resources.labels.DestinationStatus %></label>
                                    <div class="col-sm-7">
