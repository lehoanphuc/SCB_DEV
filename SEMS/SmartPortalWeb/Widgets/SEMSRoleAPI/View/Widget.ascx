<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_View_SEMSRoleAPI_Widget" %>
     ...
     <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlService" runat="server" AutoPostBack="True" 
                onselectedindexchanged="ddlService_SelectedIndexChanged" SkinID="extDDL1">
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlRole" runat="server" AutoPostBack="True" 
                onselectedindexchanged="ddlRole_SelectedIndexChanged" SkinID="extDDL1">
            </asp:DropDownList>
            </td>
    </tr>
    <tr>
