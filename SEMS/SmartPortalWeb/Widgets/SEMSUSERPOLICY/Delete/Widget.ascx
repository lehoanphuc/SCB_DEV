<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSUSERPOLICYDelete_Widget" %>

<div class="subheader">
    <h1 class="subheader-title">
        <%=Resources.labels.xoapolicy %>
    </h1>
</div>
<div class="row">
    <div class="col-sm-12">
        <div class="panel">
            ...
            <div class="panel-container">
                <div class="panel-content text-center">
                    <div class="row">
                        <div class="col-sm-12">
                            <asp:Label ID="lblError" runat="server" Text="<%$ Resources:labels, banmuonxoapolicy %>"></asp:Label>
                        </div>
                    </div>
                </div>
