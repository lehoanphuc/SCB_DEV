<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSCommonAccountDefinition_Delete_Widget" %>
<div class="subheader">
    <h1 class="subheader-title">
        <%=Resources.labels.commonAccDefDel%>
    </h1>
</div>
<div class="row">
    <div class="col-sm-12">
