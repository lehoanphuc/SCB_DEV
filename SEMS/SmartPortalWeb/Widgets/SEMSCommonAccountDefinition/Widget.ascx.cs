...
public partial class Widgets_SEMSCommonAccountDefinition_Widget : WidgetBase
{
    ...
    void BindData()
    {
        try
        {
            ...
            ds = _common.common("SEMS_ACCOM_SEARCH", searchObject, ref IPCERRORCODE, ref IPCERRORDESC);
            if (ds != null)
            {
    ...
    void BindData_SearchAdvance()
    {
        try
        {
            ...
            rptData.DataSource = null;
            DataSet ds = new DataSet();
            object[] searchObject = new object[] { Utility.KillSqlInjection(txtAccNum.Text.Trim()), Utility.KillSqlInjection(txtAccName.Text.Trim()), GridViewPaging.pageIndex * GridViewPaging.pageSize, GridViewPaging.pageSize };
            ds = _common.common("SEMS_ACCOM_ADVANDCE", searchObject, ref IPCERRORCODE, ref IPCERRORDESC);
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
    ...
    protected void rptData_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        switch (commandName)
        {
            ...
            case IPC.ACTIONPAGE.DELETE:
                //string _groupId = commandArg.ToString();
    ...
    public void deleteFunction(String id)
    {
        try
        {
            ...
            _common.common("SEMS_ACCOM_DEL", searchObject, ref IPCERRORCODE, ref IPCERRORDESC);
            if (IPCERRORCODE.Equals("0"))
            {
                lblError.Text = Resources.labels.deletesuccessfully;
            }
