    ...
    <ContentTemplate>
        <div class="subheader">
            <h1 class="subheader-title">
                <%=Resources.labels.danhsachquanhuyen %>
            </h1>
        </div>
        <div class="loading">
                                ...
                                <div class="row">
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label"><%=Resources.labels.tenquanhuyen %></label>
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:TextBox ID="txtDistName" CssClass="form-control" runat="server"></asp:TextBox>
                                                <asp:TextBox ID="txtDistCode" runat="server" Visible="false"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:TextBox ID="txtDistNameMM" CssClass="form-control" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label"><%=Resources.labels.tentinh %></label>
                                            <div class="col-sm-8 col-xs-12">
        ...
        <div id="divResult" runat="server">
            ...
            <asp:GridView ID="gvDistrictList" runat="server" BackColor="White" CssClass="table table-hover"
                ...
                OnRowDataBound="gvDistrictList_RowDataBound" OnRowCommand="gvDistrictList_RowCommand" OnRowDeleting="gvDistrictList_RowDeleting">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:labels, maquanhuyen %>">
                        <ItemTemplate>
                            <asp:LinkButton ID="lblquan" runat="server" CommandName='<%#IPC.ACTIONPAGE.DETAILS %>' CommandArgument='<%#Eval("DistCode") %>' OnClientClick="Loading();"></asp:LinkButton>
                        </ItemTemplate>
                        <HeaderStyle CssClass="gvHeader" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$ Resources:labels, tenquanhuyen %>">
                        <ItemTemplate>
                            <asp:Label ID="lbltenquan" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$ Resources:labels, tenquanhuyenMM %>">
                        <ItemTemplate>
                            <asp:Label ID="lbltenquanMM" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$ Resources:labels, tentinh %>">
                        <ItemTemplate>
                            <asp:Label ID="lbltinh" runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="left" />
                        <HeaderStyle HorizontalAlign="left" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$ Resources:labels, TownShipmanagement %>">
                        <ItemTemplate>
                            <asp:HyperLink CssClass="btn btn-primary" ID="hpTownShipManagement" runat="server">
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:labels, edit %> ">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbEdit" runat="server" CssClass="btn btn-primary" CommandName='<%#IPC.ACTIONPAGE.EDIT %>' CommandArgument='<%#Eval("DistCode") %>' OnClientClick="Loading();">Edit</asp:LinkButton>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$ Resources:labels, delete %>">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbDelete" runat="server" CssClass="btn btn-secondary" CommandName='<%#IPC.ACTIONPAGE.DELETE %>' CommandArgument='<%#Eval("DistCode") %>' OnClientClick="Loading(); return Confirm();">Delete</asp:LinkButton>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                </Columns>
...
<script>
    function SelectCbx(obj) {
        ...
        var count = document.getElementById('<%=gvDistrictList.ClientID %>').rows.length;
        var elements = document.getElementById('<%=gvDistrictList.ClientID %>').rows;
        if (obj.checked) {
            for (i = 0; i < count; i++) {
    ...
    function ChildClick(CheckBox) {
        ...
        var grid = document.getElementById('<%= gvDistrictList.ClientID %>');
