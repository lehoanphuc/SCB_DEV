<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSREGIONFEEDelete_Widget" %>
...
<div id="divCustHeader">
    <img alt="" src="widgets/SEMSREGIONFEE/Images/region2.png" style="width: 32px; height: 32px; margin-bottom:10px;" align="middle" /> 
    <%=Resources.labels.xoaregionfee %>
...
<div class="divGetInfoCust">
    <div class="divHeaderStyle">
        <%=Resources.labels.xacnhan %>
    </div>
    <table class="style1" cellspacing="0" cellpadding="5">
        <tr>
            <td align="center" class="style2">
                <asp:Label ID="Label1" runat="server" 
                    Text="<%$ Resources:labels, banchacchanmuonxoaregionfee %>"></asp:Label>
        ...
        <table class="style1" cellspacing="0" cellpadding="5">
            <tr>
                <td align="center" class="style3">
                 <asp:Label runat="server" ID="lblError" ForeColor="Red" Text="<%$ Resources:labels, xoaregionfeethanhcong %>"></asp:Label>
                </td>
