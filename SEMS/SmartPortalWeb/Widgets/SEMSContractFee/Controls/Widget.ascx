<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSContractFee_Controls_Widget" %>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <asp:Label ID="lblTenKH" runat="server" Text="<%$ Resources:labels, tenkhachhang %> " CssClass="col-sm-2 col-xs-12 control-label" Visible="false"></asp:Label>
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2 col-xs-12">
                                                <asp:Button ID="btnKiemtra" CssClass="btn btn-primary btn-block" runat="server" Text="<%$ Resources:labels, kiemtra %>" OnClientClick="return validate()" OnClick="btnKiemtra_Click" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:DropDownList ID="ddlTrans" CssClass="form-control select2" runat="server" OnSelectedIndexChanged="ddlTrans_OnSelectedIndexChanged" AutoPostBack="True" >
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:DropDownList ID="ddlPayer" CssClass="form-control select2 infinity" Enabled="False" runat="server">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="form-group">
                                             <%--<label class="col-sm-4 col-xs-12 control-label"><%=Resources.labels.feeTransfer %></label>--%>
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:DropDownList ID="ddlTransferFee" CssClass="form-control select2 infinity"  Enabled="false" runat="server" Visible="false">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
