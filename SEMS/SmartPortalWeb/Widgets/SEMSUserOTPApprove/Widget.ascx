<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSUserOTPApprove_Widget" %>
...
<div id="divCustHeader">
    ...
    <%=Resources.labels.duyetnguoidungdanglysudungotp %>
</div>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <div id="divToolbar">
            &nbsp;<asp:Button ID="btnAddNew" runat="server" Text="<%$ Resources:labels, duyet %>" OnClick="btnAddNew_Click" />
            &nbsp;<asp:Button ID="btnDelete" runat="server" Text="<%$ Resources:labels, khongduyet %>" OnClick="btnDelete_Click" />
            ...
            <asp:GridView ID="gvProductList" runat="server" BackColor="White"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:labels, nguoidung %>">
                        <ItemTemplate>
                            <asp:Label ID="hpUser" runat="server">[hpUser]</asp:Label>
                        </ItemTemplate>
                        <HeaderStyle CssClass="gvHeader" />
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="AuthenType" Visible="false">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:labels, trangthai %>" Visible="false">
                        <ItemTemplate>
