                ...
                <ItemTemplate>
                    <table width="100%">
                        <tr>
                            ...
                            <td>
                                <asp:HyperLink ID="hpNewsTitle" NavigateUrl='<%#SmartPortal.Common.Encrypt.EncryptURL(System.Configuration.ConfigurationManager.AppSettings["newsdetail"]+"&nid="+Eval("NewsID")) %>' runat="server" Text='<%# Eval("Title") %>'></asp:HyperLink>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
