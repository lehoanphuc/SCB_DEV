<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSContractPromotionApp_Controls_Widget" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:TextBox ID="txtcontractno" CssClass="form-control" MaxLength="22" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
