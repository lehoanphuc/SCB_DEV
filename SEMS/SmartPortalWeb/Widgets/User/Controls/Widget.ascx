                                ...
                                if (!data_change(document.getElementById('<%=txtPhone.ClientID%>'))) {
                                    ...
                                    for (var i = 0; i < document.getElementById('<%=txtUserName.ClientID%>').value.length; i++) {
                                        ...
                                        //if (document.getElementById('<%=txtEmail.ClientID%>').value != '') {
                                            ...
                                            {
                                                if (document.getElementById('<%=txtCBLGName.ClientID%>').value == '') {
                                                    alert('<%=Resources.labels.corebankingloginnameempty %>');
                                                    return false;
                                                }
                                                else
                                                {
                                                    if (document.getElementById('<%=txtCBUserID.ClientID%>').value == '') 
                                                    {
                                                        alert('<%=Resources.labels.corebankinguseridempty %>');
                                                        return false;
                                                    }
                                                    else
                                                    {
...
<table class="pageadd">
            <tr>
        <td class="usertdleft">
            <asp:Label ID="Label23" runat="server" Font-Bold="False" SkinID="lblImportant">*</asp:Label>
            <asp:Label ID="Label24" runat="server" SkinID="lblImportant" Text="<%$ Resources:labels, corebankingloginname %>"></asp:Label>
            :</td>
        <td>
            <asp:TextBox ID="txtCBLGName" runat="server" SkinID="txtTwoColumn" AutoPostBack="true" OnTextChanged="txtCBLGName_Changed"></asp:TextBox>
            <asp:Button runat="server" ID="btnCheck" OnClick="btnCheck_Click" Text="<%$ Resources:labels, kiemtra %>"/>
        </td>
    </tr>
        <tr>
        <td class="usertdleft">
            <asp:Label ID="Label25" runat="server" Font-Bold="False" SkinID="lblImportant">*</asp:Label>
            <asp:Label ID="Label26" runat="server" SkinID="lblImportant" Text="<%$ Resources:labels, corebankinguser %>"></asp:Label>
            :</td>
        <td>
            <asp:TextBox ID="txtCBUserID" runat="server" SkinID="txtTwoColumn" Enabled="false"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td class="usertdleft">
    ...
    <tr>
        <td class="usertdleft">
            <asp:Label ID="Label11" runat="server" Font-Bold="False" SkinID="lblImportant">*</asp:Label>
            <%--<asp:Label ID="Label11" runat="server" Text='<%$ Resources:labels, email %>'></asp:Label>--%>
            <asp:Label ID="Label19" runat="server" SkinID="lblImportant" Text='<%$ Resources:labels, email %>'></asp:Label>
            :</td>
        <td>
    ...
    <tr>
        <td class="usertdleft">
            ...
            :</td>
        <td>
            <asp:Label ID="txtBirth" runat="server" Mask="nn/nn/nnnn"></asp:Label>
    ...
    <tr>
        <td class="usertdleft">
            ...
            <asp:Label ID="Label20" runat="server" Text="<%$ Resources:labels, branch %>"></asp:Label>
            &nbsp;:</td>
        <td>
            <asp:DropDownList ID="ddlBranch" runat="server" SkinId="PNBShit1">
            </asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td class="usertdleft">
            <asp:Label ID="Label27" runat="server" Text="<%$ Resources:labels, capbac %>"></asp:Label>
            :</td>
        <td>
    ...
    <tr  style="height:25px">
        <td class="usertdleft"  >
            <img alt="" src="widgets/SEMSUSERPOLICY/Images/policy_icon.jpg" style="width: 16px; height: 16px;"  />
                <asp:Label Text='<%$ Resources:labels, dungpolicy %>' runat="server" style="vertical-align: super;"></asp:Label>:
                                            
            <%--<asp:Label ID="Label60" runat="server" Font-Bold="true" ForeColor="Red" Text="<%$ Resources:labels, dungpolicy %>"></asp:Label>--%>
        </td>
        <td valign="top" style="width: 25%;">
            <asp:DropDownList  ID="ddlpolicySEMS" runat="server" Height="25px"></asp:DropDownList>    
        </td>
        </tr>
        <tr>
        <td class="usertdleft">
            <asp:Label ID="Label21" runat="server" Text="<%$ Resources:labels, loaihinh %>"></asp:Label>
            :</td>
        <td>
        ...
        <tr>
        <td class="usertdleft">
            <asp:Label ID="Label22" runat="server" Text="<%$ Resources:labels, corebankinguser %>"></asp:Label>
            :</td>
        <td>
            <asp:TextBox ID="txtCoreUser" runat="server">
            </asp:TextBox>
        </td>
    </tr>
    <tr>
