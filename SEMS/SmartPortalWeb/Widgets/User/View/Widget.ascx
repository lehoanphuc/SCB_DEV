...
<link href="Widgets/User/View/CSS/StyleSheet.css" rel="stylesheet" type="text/css" />
<script src="Widgets/User/View/Scripts/JScript.js" type="text/javascript"></script>


<div style="padding:5px 0px 5px 5px;">
    <img alt="" src="widgets/User/view/images/add.gif" style="width: 16px; height: 16px" />
    <asp:LinkButton ID="lbAddPage" Text='<%$ Resources:labels, adduser %>' 
        runat="server" onclick="lbAddPage_Click"></asp:LinkButton>
    &nbsp;
    <img alt="" src="widgets/User/view/images/action_delete.gif" style="width: 16px; height: 16px" /><asp:LinkButton ID="lbDeleteSelected" 
    ...
    <tr>
        <td>
            <asp:GridView ID="gvUser" runat="server" AllowPaging="True" 
                ...
                onpageindexchanging="gvUser_PageIndexChanging" onsorting="gvUser_Sorting" >
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText='<%$ Resources:labels, username %>' SortExpression="UserName">
                        <ItemTemplate>
                           <asp:HyperLink ID="hpUserName" runat="server"></asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField> 
                    
                    <asp:TemplateField HeaderText='<%$ Resources:labels, firstname %>' SortExpression="FirstName">
                        <ItemTemplate>
                            <img src="widgets/user/view/images/user.gif" />
                    ...
                    <asp:TemplateField HeaderText='<%$ Resources:labels, lastlogintime %>' SortExpression="LastLoginTime">
                        <ItemTemplate>
                          <center><asp:Label ID="lblLastLoginTime" runat="server"></asp:Label></center>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText='<%$ Resources:labels, group %>'>
                        <ItemTemplate>
                            
                           <center><asp:HyperLink ID="hpGroup" runat="server">HyperLink</asp:HyperLink></center> 
...
<div style="padding:5px 0px 5px 5px;">
    <hr />
    <img alt="" src="widgets/User/view/images/add.gif" style="width: 16px; height: 16px" />
    <asp:LinkButton ID="LinkButton1" Text='<%$ Resources:labels, adduser %>' 
        runat="server" onclick="lbAddPage_Click"></asp:LinkButton>
    &nbsp;
    <img alt="" src="widgets/User/view/images/action_delete.gif" style="width: 16px; height: 16px" /><asp:LinkButton ID="LinkButton2" 
        Text='<%$ Resources:labels, deleteselected %>' runat="server" onclick="lbDeleteSelected_Click" 
        ></asp:LinkButton>
     &nbsp;
     <img alt="" src="widgets/pages/view/images/back.gif" style="width: 16px; height: 16px" />
