...
public partial class Widgets_User_View_Widget : WidgetBase
{
    ...
    private void BindData()
    {
        ...
        {
            letter=Request["letter"].ToString().Trim();
        }
    ...
    {
        Response.Redirect(SmartPortal.Common.Encrypt.EncryptURL(System.Configuration.ConfigurationManager.AppSettings["adduser"]));
    }
    protected void lbDeleteSelected_Click(object sender, EventArgs e)
    {
        ...
        if (username != "")
        {
            ...
            Response.Redirect(SmartPortal.Common.Encrypt.EncryptURL(System.Configuration.ConfigurationManager.AppSettings["deleteuser"]));
        }
        else
        {
            BindData();
