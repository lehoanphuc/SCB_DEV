<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_NewsManagement_View_Widget" %>
...
<div style="padding:5px 0px 5px 5px;">
    <img alt="" src="widgets/newsmanagement/view/Images/add.gif" style="width: 16px; height: 16px" />
    <asp:LinkButton ID="lbAddPage" Text='<%$ Resources:labels, addnews %>' 
        runat="server" onclick="lbAddPage_Click" ></asp:LinkButton>
    &nbsp;
    <img alt="" src="widgets/newsmanagement/view/Images/action_delete.gif" style="width: 16px; height: 16px" /><asp:LinkButton ID="lbDeleteSelected" 
...
<table style="margin:5px auto 5px auto; width:100%;">
    <tr>
        <td>
            <asp:GridView ID="gvNewsManagement" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" 
                ForeColor="#333333" GridLines="None" 
                 PageSize="15" Width="100%" 
                onpageindexchanging="gvNewsManagement_PageIndexChanging" 
                onrowdatabound="gvNewsManagement_RowDataBound" 
                onsorting="gvNewsManagement_Sorting">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText='<%$ Resources:labels, author %>' SortExpression="NewsAuthor">
                        <ItemTemplate>
                            <asp:Label ID="lblNewsAuthor" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
...
<div style="padding:5px 0px 5px 5px;">
     <hr />
    <img alt="" src="widgets/newsmanagement/view/Images/add.gif" style="width: 16px; height: 16px" />
    <asp:LinkButton ID="LinkButton1" Text='<%$ Resources:labels, addnews %>' 
        runat="server" onclick="lbAddPage_Click" ></asp:LinkButton>
    &nbsp;
    <img alt="" src="widgets/newsmanagement/view/Images/action_delete.gif" style="width: 16px; height: 16px" /><asp:LinkButton ID="LinkButton2" 
        Text='<%$ Resources:labels, deleteselected %>' runat="server" onclick="lbDeleteSelected_Click" 
         ></asp:LinkButton>
      &nbsp;
    <img alt="" src="widgets/pages/view/images/back.gif" style="width: 16px; height: 16px" />
