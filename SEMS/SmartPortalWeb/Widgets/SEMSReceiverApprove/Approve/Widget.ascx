...
<div class="divGetInfoCust">
    <div class="divHeaderStyle">
      <asp:Label ID="lblLabel1" runat="server" Text="<%$ Resources:labels, thongtinxacnhan %>"></asp:Label>
    </div>
...
&nbsp;
    <asp:Button ID="btsaveandcont" runat="server" Text="<%$ Resources:labels, thuchien %>" Width="71px" 
