<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSBankList_Widget" %>
...
<div id="divProductHeader">
    <img alt="" src="widgets/SEMSBank/Images/Bank.png" style="width: 32px; height: 32px; margin-bottom:10px;" align="middle" /> <%=Resources.labels.danhsachchinhanhnganhang%>
...
<asp:Panel ID="pnSearch" runat="server" DefaultButton="btnSearch">
    <table class="style1">
        <tr>
            ...
            <td>
                <asp:Label ID="Label2" runat="server" Text="<%$ Resources:labels, chinhanhphonggiaodich %>"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtchildbank" runat="server" Width="40%"></asp:TextBox>
            </td>
            <td width="10%">
        ...
        <tr>
            <td>
                <asp:Label ID="Label3" runat="server" Text="<%$ Resources:labels, machinhanh %>"></asp:Label>
            </td>
            <td>
                    <asp:TextBox ID="txtbankcode" runat="server" Width="40%"></asp:TextBox>
            </td>
            <td>
...
<div id="divResult">
    <asp:GridView ID="gvProductList" runat="server" BackColor="White" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="<%$ Resources:labels, chinhanh%>" SortExpression="BANKNAME">
                <ItemTemplate>
                <asp:HyperLink ID="hpbankname" runat="server"></asp:HyperLink>  
                </ItemTemplate>
                 <HeaderStyle CssClass="gvHeader" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="<%$ Resources:labels, machinhanh%>" SortExpression="BANKCODE">
                <ItemTemplate>
                    <asp:Label ID="lblbankcode" runat="server"></asp:Label>
                </ItemTemplate>
                 <HeaderStyle CssClass="gvHeader" />
            </asp:TemplateField>
                        <asp:TemplateField HeaderText="<%$ Resources:labels, nganhang%>" SortExpression="ROOTBANK">
                <ItemTemplate>
                    <asp:Label ID="lblrootbank" runat="server" ></asp:Label>
                </ItemTemplate>
                 <HeaderStyle CssClass="gvHeader" />
            </asp:TemplateField>
                        <asp:TemplateField HeaderText="<%$ Resources:labels, tinhthanh%>" SortExpression="CITYNAME">
                <ItemTemplate>
                    <asp:Label ID="lblcityname" runat="server"></asp:Label>
                </ItemTemplate>
                 <HeaderStyle CssClass="gvHeader" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="<%$ Resources:labels, chuyendien%>" SortExpression="REMITTANCE">
                <ItemTemplate>
                    <asp:Label ID="lblremittance" runat="server" ></asp:Label>
                </ItemTemplate>
                 <HeaderStyle CssClass="gvHeader" />
            </asp:TemplateField>
