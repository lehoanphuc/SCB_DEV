<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_PagePermission_Widget" %>

<link href="Widgets/PagePermission/CSS/StyleSheet.css" rel="stylesheet" type="text/css" />
...
<table id="pageadd" cellspacing="1">
    ...
    <tr>
        <td class="tdleft" valign="top">
            ...
            <asp:Label ID="Label3" runat="server" Text='<%$ Resources:labels, pagename %>'></asp:Label>
            :
        </td>
        <td>
