            ...
            catch (BusinessExeption bex)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["themeiec"], "Widgets_Theme_Controls_Widget", "btnSave_Click", bex.ToString(), Request.Url.Query);
        ...
        else
        {
            ...
            catch (BusinessExeption bex)
            {
                ...
                else
                {
                    ...
                    {
                        SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["themeuec"], "Widgets_Theme_Controls_Widget", "btnSave_Click", bex.ToString(), Request.Url.Query);
