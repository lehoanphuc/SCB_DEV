<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSUserTypeIsBackOffice_Widget" %>
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <asp:DropDownList ID="ddUserType" CssClass="form-control select2"  ReadOnly="true" OnSelectedIndexChanged="loadInfo" AutoPostBack="true" runat="server"></asp:DropDownList>
                                            </div>
                                        </div>
