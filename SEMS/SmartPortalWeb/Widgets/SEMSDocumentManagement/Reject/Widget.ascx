<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSDocumentManagementReason_Widget" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <div id="divSearch">
            <div class="subheader">
                <h1 class="subheader-title">
                    <%=Resources.labels.DocumentManagementReason%>
                </h1>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <uc1:Reason ID="txtReason" CssClass="form-control" IsRequired="true" TabIndex="0" runat="server"></uc1:Reason>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12">
        ...
        <div class="panel-content div-btn rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted">
            <asp:Button ID="btnComplete" CssClass="btn btn-primary" runat="server" Text="<%$ Resources:labels, Complete %>" OnClick="btnComplete_Click" />
