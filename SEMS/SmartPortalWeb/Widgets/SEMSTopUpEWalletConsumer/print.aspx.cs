...
public partial class Widgets_SEMSContractFee_print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            tmpl = SmartPortal.Common.ST.GetStringTemplate("SEMSTopUpEWalletConsumer", "TopUpEWalletConsumer-US");
            string results = "";
            ...
            string key = "TOPUP_" + HttpContext.Current.Session["userID"].ToString() + results;
            if (Cache[key] != null)
            {
                ...
                tmpl.SetAttribute("BONUS_AMOUNT", hasPrint["BONUS_AMOUNT"].ToString());
