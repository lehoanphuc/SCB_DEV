<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSChangeContractLevelofAgent_Widget" %>
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-hdr">
                <h2>
                    <%=Resources.labels.ChangeContractLevelofAgent%>
                </h2>
            </div>
                    ...
                    <asp:Panel ID="pnSearch" runat="server" DefaultButton="btnAccept">
                        <div class="row">
                            <div class="col-sm-7">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-5 control-label required"><%=Resources.labels.SourceWalletLevel %></label>
                                    <div class="col-sm-7">
                                        <asp:DropDownList ID="ddlSourceWalletLevel" CssClass="form-control select2" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-5 control-label required"><%=Resources.labels.DestinationWalletLevel %></label>
                                    <div class="col-sm-7">
