<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSChangeConsumerStatus_Widget" %>
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-hdr">
                <h2>
                    <%=Resources.labels.ChangeCustomerStatus%>
                </h2>
            </div>
                ...
                <div class="panel-content form-horizontal p-b-0">
                    <asp:Panel ID="pnSearch" runat="server" DefaultButton="btnAccept">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-offset-2 control-label"><%=Resources.labels.ConsumerCode %> (*)</label>
                                    <div class="col-sm-4">
                                        <asp:TextBox ID="txtConsumerCode" CssClass="form-control" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-4"></div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-offset-2 control-label"><%=Resources.labels.SourceStatus %> (*)</label>
                                    <div class="col-sm-4">
                                        <asp:DropDownList ID="ddlSourceStatus" CssClass="form-control select2" runat="server"></asp:DropDownList>
                                    </div>
                                    <div class="col-sm-4"></div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-offset-2 control-label"><%=Resources.labels.DestinationStatus %> (*)</label>
                                    <div class="col-sm-4">
                                        <asp:DropDownList ID="ddlDestinationStatus" CssClass="form-control select2" runat="server"></asp:DropDownList>
                                    </div>
                                    <div class="col-sm-4"></div>
                                </div>
                            </div>
