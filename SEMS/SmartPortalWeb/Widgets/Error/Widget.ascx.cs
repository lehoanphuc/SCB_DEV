...
public partial class Widgets_Error_Widget : WidgetBase
{
    ...
    protected void btnExit_Click(object sender, EventArgs e)
    {
        ...
        {
           Response.Redirect(SmartPortal.Common.Encrypt.EncryptURL(SmartPortal.Common.Encrypt.DecryptData(SmartPortal.Common.Encrypt.GetURLParam(System.Web.HttpContext.Current.Request.RawUrl)["returnurl"])));
        }
    }
    protected void btnSave_Click(object sender, EventArgs e)
    {
       Response.Redirect(SmartPortal.Common.Encrypt.EncryptURL(System.Configuration.ConfigurationManager.AppSettings["homebank"]));
    }
}
