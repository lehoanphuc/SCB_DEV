<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSHUBCMSLink_Delete_Widget" %>
...
<div id="divCustHeader">
    ...
    <%=Resources.labels.xoathongtincms %>

</div>
<div id="divError" style="font-weight:bold; margin-bottom:5px;">
        ...
        <tr>
            <td align="center" class="style2">
                <asp:Label ID="Label1" runat="server" 
                    Text="<%$ Resources:labels, xacnhanxoathongtincms %>"></asp:Label>
            </td>
   ...
   <%=Resources.labels.ketquagiaodich %>
                    ...
                    <div class="content">
                        ...
                        <asp:Label ID="lbresult" runat="server" ForeColor="Red" Font-Bold="true"
                            Text="<%$ Resources:labels, xoathanhcongthongtincms %>"></asp:Label>
                        </div>
