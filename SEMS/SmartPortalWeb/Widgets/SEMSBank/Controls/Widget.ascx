<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSBank_Controls_Widget" %>
...
<div class="divHeaderStyle">
    ...
    <table class="style1" cellpadding="3">
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtBank" runat="server" SkinId="PNBFuck"></asp:TextBox>
            </td>
...
<script language="javascript">
    function validate() {
        if (validateEmpty('<%=txtBank.ClientID %>', '<%=Resources.labels.bancannhaptennganhang %>')) {
