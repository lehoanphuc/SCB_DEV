<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSCloseCustomerCodeofConsumer_Widget" %>

<%--<div class="subheader">
    <h1 class="subheader-title">
        <%=Resources.labels.ChangeCustCloseCustomerCodeofConsumeromerStatus %>
    </h1>
</div>--%>
<div id="divError">
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-hdr">
                <h2>
                    <%=Resources.labels.CloseCustomerCodeofConsumer%>
                </h2>
            </div>
