<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSPartnerBank_Widget" %>
    ...
    <ContentTemplate>
        <div class="subheader">
            <h1 class="subheader-title">
                <%= Resources.labels.danhsachdoitac %>
            </h1>
        </div>
        <div class="loading">
                                    ...
                                    <div class="col-sm-10 col-xs-12">
                                        <div class="row">
                                            <div class="form-group col-sm-6 col-xs-12">
                                                <label class="col-sm-4 col-xs-12 control-label"><%= Resources.labels.madoitac %></label>
                                                <div class="col-sm-8 col-xs-12">
                                                    <asp:TextBox ID="txtbankcode" CssClass="form-control" runat="server"  />
                                                </div>
                                            </div>
                                            <div class="form-group col-sm-6 col-xs-12">
        ...
        <div id="divResult" runat="server">
            ...
            <asp:GridView ID="gvBankList" CssClass="table table-hover" runat="server" BackColor="White"
                ...
                Width="100%" AutoGenerateColumns="False" OnRowDataBound="gvBankList_RowDataBound" OnRowCommand="gvBankList_RowCommand" OnRowDeleting="gvBankList_RowDeleting">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:labels, madoitac %>">
                        <ItemTemplate>
                            <asp:Label ID="lblbankid" runat="server" Visible="False" />
                            <asp:LinkButton ID="lblBankCode" runat="server" MaxLength="50" CommandName='<%#IPC.ACTIONPAGE.DETAILS %>' CommandArgument='<%#Eval("BankID") %>' OnClientClick="Loading();" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$ Resources:labels, tendoitac %>">
                        <ItemTemplate>
                            <asp:Label ID="lblBankName" runat="server" MaxLength="255"/>
                        </ItemTemplate>
                    </asp:TemplateField>
