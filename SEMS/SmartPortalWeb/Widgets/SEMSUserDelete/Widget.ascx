<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSUserDetele_Widget" %>
...
<div id="divCustHeader">
    <img alt="" src="widgets/SEMSUserDelete/Images/user.png" style="width: 40px; height: 32px; margin-bottom:10px;" align="middle" /> 
    <%=Resources.labels.xoanguoisudung %>
        ...
        <tr>
            <td align="center" class="style2">
                <asp:Label ID="Label1" runat="server" 
                    Text="<%$ Resources:labels, banchachanmuonxoanguoisudungnaykhong %>"></asp:Label>
            </td>
