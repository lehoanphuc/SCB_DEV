<%@ control language="C#" autoeventwireup="true" codefile="Widget.ascx.cs" inherits="Widgets_SEMSLISTHISTORYAPROVE_ViewDetails_Widget" %>
<div class="subheader">
            ...
            <div class="panel">
                ...
                <div class="panel-container">
                    <div class="panel-content form-horizontal p-b-0">
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <asp:Panel ID="pnsenddinfoSimple" Visible="true" runat="server">
                                    <table id="Table1" runat="server" cellspacing="1" cellpadding="3">
                                        <tr id="trinfo_sim_edit" runat="server" visible="true">
                    ...
                    <div class="panel-content div-btn rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted">
                        ...
                        <asp:Button ID="btnRollBack" CssClass="btn btn-primary" runat="server" Text="<%$ Resources:labels, rollback %>" OnClientClick="Loading();" OnClick="btnRollBack_Click" />
                        ...
                        <asp:Button ID="btnBack" CssClass="btn btn-secondary" runat="server" Text="<%$ Resources:labels, back %>" OnClientClick="Loading();" OnClick="btback_OnClickck_Click" />
