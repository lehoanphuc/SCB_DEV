<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSUserTypeNoBackOffice_Widget" %>
<%@ Register Src="~/Controls/SearchTextBox/UserSearch.ascx" TagPrefix="uc1" TagName="UserSearch" %>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-hdr">
                        <h2>
                            <%=Resources.labels.ChangeUserStatus%>
                        </h2>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <asp:DropDownList ID="ddUserType" CssClass="form-control select2" ReadOnly="true" OnSelectedIndexChanged="changeCustomerType_LoadInfo" AutoPostBack="true" runat="server"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label required"><%=Resources.labels.UserCode %></label>
                                            <div class="col-sm-8">
                                                <uc1:UserSearch runat="server" ID="txtUserCode" />
                                            </div>
                                        </div>
                                        <div class="form-group">
