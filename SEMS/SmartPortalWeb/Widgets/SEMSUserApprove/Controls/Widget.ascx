<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSUserApprove_Controls_Widget" %>
                        ...
                        <asp:Panel ID="pnAdd" runat="server">
                            <div class="row">
                                ...
                                <div class="col-sm-6" runat="server" id="divnamecsm" >
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <asp:TextBox ID="txtLocalName" CssClass="form-control" placeholder="Local full name" runat="server" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6" runat="server">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label"><%=Resources.labels.account %></label>
                                        <div class="col-sm-8">
                                        ...
                                        <div class="row" style="margin-top: 5px">
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group" runat="server" visible="false">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <asp:DropDownList ID="ddlauthenType" CssClass="form-control select2 infinity" Width="100%" runat="server" Enabled="false">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <asp:TextBox ID="txtDescription" CssClass="form-control" MaxLength="250" runat="server" TextMode="MultiLine" onkeyup="ValidateLimit(this,'250');" onkeyDown="ValidateLimit(this,'250');" onpaste="ValidateLimit(this,'250');" onChange="ValidateLimit(this,'250');" onmousedown="ValidateLimit(this,'250');"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-2"></div>
