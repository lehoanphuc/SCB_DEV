<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_NewsApprove_Widget" %>

<link href="Widgets/NewsApprove/CSS/StyleSheet.css" rel="stylesheet" type="text/css" />
<script src="Widgets/NewsApprove/Scripts/JScript.js" type="text/javascript"></script>

<link href="Widgets/NewsApprove/CSS/SyntaxHighlighter.css" rel="stylesheet" type="text/css" />

<script src="Widgets/NewsApprove/Scripts/shCore.js" type="text/javascript"></script>

<script src="Widgets/NewsApprove/Scripts/shBrushJScript.js" type="text/javascript"></script>

<script src="Widgets/NewsApprove/Scripts/ModalPopups.js" type="text/javascript"></script>




<div style="padding:5px 0px 5px 5px;">
    <img id="imgApprove" alt="" src="~/widgets/newsapprove/Images/adminapproval_icon_smll.gif" 
        style="width: 15px; height: 15px" runat="server" />
    <asp:LinkButton  ID="lbAddPage" Text='<%$ Resources:labels, approve %>' 
        runat="server" onclick="lbAddPage_Click" ></asp:LinkButton>
&nbsp;
    <img id="imgUnApprove" alt="" src="~/widgets/newsapprove/Images/lock_user_icon.png" runat="server" style="width: 16px; height: 16px" />
...
&nbsp;<asp:Panel ID="pnCondition" runat="server" 
        ...
        <table>
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="Label2" runat="server" Text="<%$ Resources:labels, category %>"></asp:Label>
                    :</td>
                <td>
...
<table style="margin:5px auto 5px auto; width:100%;">
    <tr>
        <td>
            <asp:GridView ID="gvNewsApprove" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" 
                ForeColor="#333333" GridLines="None" 
                 PageSize="15" Width="100%" onrowdatabound="gvNewsApprove_RowDataBound" 
                onpageindexchanging="gvNewsApprove_PageIndexChanging" onsorting="gvNewsApprove_Sorting" 
               >
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText='<%$ Resources:labels, title %>' SortExpression="Title">
                        <ItemTemplate>
                           <asp:HyperLink ID="hpTitle" runat="server"></asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField>                    
                    <asp:TemplateField HeaderText='<%$ Resources:labels, author %>' SortExpression="NewsAuthor">
                        <ItemTemplate>
                            <center><asp:Label ID="lblNewsAuthor" runat="server"></asp:Label></center>
                        </ItemTemplate>
                    </asp:TemplateField>
...
<div style="padding:5px 0px 5px 5px;">
     <hr />
    <img id="imgApprove1" alt="" src="~/widgets/newsapprove/Images/adminapproval_icon_smll.gif" 
        style="width: 15px; height: 15px" runat="server" />
    <asp:LinkButton ID="lbAddPage1" Text='<%$ Resources:labels, approve %>' 
        runat="server" onclick="lbAddPage_Click" ></asp:LinkButton>
&nbsp;
    <img id="imgUnApprove1" alt="" src="~/widgets/newsapprove/Images/lock_user_icon.png" runat="server" style="width: 16px; height: 16px" />
...
<script src="Widgets/NewsApprove/Scripts/shInit.js" type="text/javascript"></script>
<script>
