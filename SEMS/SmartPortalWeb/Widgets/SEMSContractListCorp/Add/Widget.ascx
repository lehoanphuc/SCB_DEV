<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSContractListCorp_Add_Widget" %>
...
<link rel="stylesheet" href="widgets/SEMSCustomerListCorp/css/example.css" type="text/css" media="screen">
...
<div id="divCustHeader">
    <img alt="" src="widgets/SEMSContractList/Images/handshake.png" style="width: 32px; height: 32px; margin-bottom: 10px;" align="middle" />
    <%=Resources.labels.themmoihopdongdoanhnghiep %>
</div>
<div id="divError">
...
<!--lua chon phuong thuc tao hop dong-->
<asp:Panel runat="server" ID="pnOption">
    <div class="divGetInfoCust">
        <div class="divHeaderStyle">
            <%=Resources.labels.phuongthuctaohopdong %>
        </div>
        <table class="style1" cellspacing="0" cellpadding="5">
            <tr>
                <td>
                    <asp:RadioButton ID="radNewCust" runat="server" Checked="True"
                        GroupName="CustInfo" Text="<%$ Resources:labels, khachhangmoi %>" />
                </td>

                <td>
                    <asp:RadioButton ID="radCustExists" runat="server" GroupName="CustInfo"
                        Text="<%$ Resources:labels, khachhangdatontai %>" />
                </td>

                <td style="width: 10%;">
                    <asp:Button ID="btnStart" runat="server" Text="<%$ Resources:labels, batdau %>"
...
<asp:Panel runat="server" ID="pnCustInfo">
    <div class="divGetInfoCust">
        ...
        <table class="style1">
            ...
            <tr>
                <td>
                    <asp:Label ID="lblct" runat="server" Text="<%$ Resources:labels, loaikhachhang %>" Visible="False"></asp:Label>
                </td>
                <td>
                ...
                <td>
                    ...
                    <asp:ListItem Value="A">Sử dụng</asp:ListItem>
        ...
        <div style="height: 400px; overflow: auto;">
            <asp:GridView ID="gvCustomerList" runat="server" BackColor="White"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:RadioButton ID="cbxSelect" runat="server" GroupName="88" onclick="javascript:CheckOtherIsCheckedByGVID(this)" />
                        </ItemTemplate>
    ...
    <div style="text-align: center; padding-top: 10px;">
        &nbsp;<asp:Button ID="btnNext" runat="server" OnClick="btnNext_Click"
            Text="<%$ Resources:labels, next %>" ValidationGroup="GroupA" />
        &nbsp;
...
<asp:Panel runat="server" ID="pnContractInfo">
    ...
    <div style="text-align: center; padding-top: 10px;">
        &nbsp;<asp:Button ID="btnContractNext" runat="server"
            OnClick="btnContractNext_Click" OnClientClick="return validate()"
...
<asp:Panel runat="server" ID="pnPersonal">
    ...
    <div class="tabber">
        ...
        <div class="tabbertab">
            <h2><%=Resources.labels.thongtinchutaikhoan %></h2>
            <p>
                        ...
                        <table class="style1" cellspacing="0" cellpadding="5">
                            <tr>
                                <td>
                                    ...
                                    &nbsp;*</td>
                                <td>
                                    <asp:TextBox ID="txtReFullName" Enabled="false" runat="server"></asp:TextBox>
                                </td>
                                <td>
      ...
      //]]></script>
                    ...
                    <div id="divAccountInfo" style="margin-top: 10px;">
                        <div class="divGetInfoCust">
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <td style="width: 25%;">
                                        <asp:RadioButton ID="radAllAccount" Checked="true" GroupName="AccInfoCTK"
                                            runat="server" Text="<%$ Resources:labels, tatcataikhoan %>" onClick="enableACCTK();" />
                                    </td>
                                    <td style="width: 25%;"></td>
                                    <td style="width: 25%;">
                                        <asp:RadioButton ID="radAccount" GroupName="AccInfoCTK" runat="server"
                                            Text="<%$ Resources:labels, theotaikhoan %>" onClick="enableACTK();" />
                                    </td>
                                    <td style="width: 25%;">
                                ...
                                <table id="tblIB" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color: #E0ECFF">
                                            <asp:Label ID="Label5" runat="server" Font-Bold="true" Text="<%$ Resources:labels, quyensudung %>"></asp:Label>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td style="width: 25%; height: 25px" valign="top">
                                            <asp:Label ID="Label20" runat="server" Text="<%$ Resources:labels, username %>"></asp:Label>
                                        </td>
                                        <td valign="top" style="width: 25%;">
                                            <asp:TextBox ID="txtIBUserName" runat="server" Enabled="false"></asp:TextBox>
                                        </td>
        ...
        <asp:Button ID="btnThemChuTaiKhoan" runat="server" Text='<%$ Resources:labels, them %>'
            Width="170px" OnClick="btnThemChuTaiKhoan_Click"
            OnClientClick="return validate1();" />
                                &nbsp;
        <asp:Button ID="btnHuyCTK" runat="server" OnClick="btnHuyCTK_Click"
            Text="<%$ Resources:labels, delete %>" />
                            ...
                            <div id="div3" style="margin-top: 20px; height: 150px; overflow: auto;">
                                ...
                                <asp:GridView ID="gvResultChuTaiKhoan" runat="server"
                                    ...
                                    BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%" OnPageIndexChanging="gvResultChuTaiKhoan_PageIndexChanging"
                                    PageSize="5" OnRowDeleting="gvResultChuTaiKhoan_RowDeleting">
        ...
        <div class="tabbertab">
            <h2><%=Resources.labels.thongtinnguoiuyquyen %></h2>
            <p>
                    ...
                    <div class="divGetInfoCust">
                        ...
                        <asp:Panel ID="UpdatePanel6" runat="server">
                            ...
                            <table class="style1" cellspacing="0" cellpadding="5">
                                <tr>
                                    <td>
                                        <asp:Label ID="Label17" runat="server" Text="<%$ Resources:labels, coownercode %>"></asp:Label>
                                        &nbsp;*
                                    </td>
                                    <td>
                                        ...
                                        <asp:UpdateProgress ID="UpdateProgress7" DisplayAfter="0"
                                            runat="server">
                                            <ProgressTemplate>
                                                <img alt="" src="widgets/SEMSCustomerList/Images/ajaxloader.gif" style="width: 16px; height: 16px;" />
                                                <%=Resources.labels.loading %>
    ...
    //]]></script>
                    ...
                    <div id="divAccountSelectUyQuyen" style="margin-top: 10px;">
                        <div class="divGetInfoCust">
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <td style="width: 25%;">
                                        <asp:RadioButton ID="radAllAccountNguoiUyQuyen" Checked="true"
                                            GroupName="AccInfoNUQ" runat="server" Text="<%$ Resources:labels, tatcataikhoan %>" onclick="enableACNUQ();" />
                                    </td>
                                    <td style="width: 25%;"></td>
                                    <td style="width: 25%;">
                        ...
                        <div id="dhtmlgoodies_tabView2">
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="Table1" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        <td style="width: 25%; height: 25px" valign="top">
                                            <asp:Label ID="Label14" runat="server" Text="<%$ Resources:labels, username %>"></asp:Label>
                                        </td>
                                        <td valign="top" style="width: 25%;">
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="Table2" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        <td style="width: 20%;" valign="top">
                                            <asp:CheckBox ID="cbNUQTKMD" runat="server" Text="<%$ Resources:labels, sudungmacdinh %>" />
                                        </td>
                                        <td valign="top">&nbsp;</td>
                                    </tr>
                                </table>
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="Table3" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        <td style="width: 25%;" valign="top">
                                            <asp:Label ID="Label49" runat="server" Text="<%$ Resources:labels, username %>"></asp:Label>
                                        </td>
                                        <td style="width: 25%;" valign="top">
		     ...
		     <tr>
                 <td style="width: 25%;" valign="top">
                     <asp:Label ID="Label11" runat="server" Text="<%$ Resources:labels, taikhoanmacdinh %>"></asp:Label>
                 </td>
                 <td style="width: 25%;" valign="top">
                     <asp:DropDownList ID="ddlNUQDefaultAcctno" runat="server">
                     </asp:DropDownList>
                 </td>
             </tr>
                                </table>
                    ...
                    <asp:UpdatePanel ID="upNUY" runat="server">
                        <ContentTemplate>
                            <div style="text-align: right;">
                                <asp:Button ID="btnThemNguoiUyQuyen" runat="server"
                                    OnClick="btnThemNguoiUyQuyen_Click" OnClientClick="return validate2();"
                                    Text='<%$ Resources:labels, them %>' Width="170px" />
                                &nbsp;
        <asp:Button ID="btnNUY" runat="server" OnClick="btnNUY_Click" Text="<%$ Resources:labels, delete %>" />
                                &nbsp;
        <asp:Button ID="btnResetNguoiUyQuyen" runat="server"
            OnClick="btnResetNguoiUyQuyen_Click" Text="<%$ Resources:labels, themmoi %>" />
                                &nbsp;
                            </div>
                            ...
                            <div id="divResultNguoiUyQuyen" style="margin-top: 20px; height: 150px; overflow: auto;">
                                ...
                                <asp:GridView ID="gvResultNguoiUyQuyen" runat="server"
                                    AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC"
                                    BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%" OnPageIndexChanging="gvResultNguoiUyQuyen_PageIndexChanging"
                                    PageSize="5" OnRowDeleting="gvResultNguoiUyQuyen_RowDeleting">
                                    <RowStyle ForeColor="#000066" />
                                    <Columns>
                                        <asp:BoundField HeaderText="<%$ Resources:labels, nguoidung %>" DataField="colFullName" />
                                        <asp:BoundField DataField="colIBUserName" HeaderText="<%$ Resources:labels, username %>" />
        ...
        <div class="tabbertab">
            <h2><%=Resources.labels.thongtinnguoidungcaphai %></h2>
            <p>
                    ...
                    <div class="divGetInfoCust">
                        ...
                        <asp:Panel ID="UpdatePanel7" runat="server">
                            ...
                            <table class="style1" cellspacing="0" cellpadding="5">
                                <tr>
                                    <td>
                                        <asp:Label ID="Label18" runat="server" Text="<%$ Resources:labels, secondusercode %>"></asp:Label>
                                        &nbsp;*
                                    </td>
                                    <td>
                                        ...
                                        <asp:UpdateProgress ID="UpdateProgress8" DisplayAfter="0"
                                            runat="server">
                                            <ProgressTemplate>
                                                <img alt="" src="widgets/SEMSCustomerList/Images/ajaxloader.gif" style="width: 16px; height: 16px;" />
                                                <%=Resources.labels.loading %>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label60" runat="server" Text="<%$ Resources:labels, capbac %>" Visible="false"></asp:Label>
                                    </td>
                                    <td>
    ...
    //]]></script>
                    ...
                    <div id="div1" style="margin-top: 10px;">
                        <div class="divGetInfoCust">
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <td style="width: 25%;">
                                        <asp:RadioButton ID="radAllAccountLevel2" Checked="true"
                                            GroupName="AccInfoL2" runat="server" Text="<%$ Resources:labels, tatcataikhoan %>" onclick="enableACL2();" />
                                    </td>
                                    <td style="width: 25%;"></td>
                                    <td style="width: 25%;">
                                        <asp:RadioButton ID="radAccountLevel2" GroupName="AccInfoL2" runat="server"
                                            Text="<%$ Resources:labels, theotaikhoan %>" onclick="enableAL2();" />
                                    </td>
                                    <td style="width: 25%;">
                        ...
                        <div id="tabLevel2">
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="Table5" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        <td style="width: 25%; height: 25px" valign="top">
                                            <asp:Label ID="Label69" runat="server" Text="<%$ Resources:labels, username %>"></asp:Label>
                                        </td>
                                        <td valign="top" style="width: 25%;">
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="Table6" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        <td style="width: 20%;" valign="top">
                                            <asp:CheckBox ID="cbNDC2TKMD" runat="server" Text="<%$ Resources:labels, sudungmacdinh %>" />
                                        </td>
                                        <td valign="top">&nbsp;</td>
                                    </tr>
                                </table>
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="Table7" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        <td style="width: 25%; height: 25px" valign="top">
                                            <asp:Label ID="Label77" runat="server" Text="<%$ Resources:labels, username %>"></asp:Label>
                                        </td>
                                        <td style="width: 25%;" valign="top">
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="Table8" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        <td style="width: 25%;" valign="top">
                                            <asp:Label ID="Label80" runat="server" Text="<%$ Resources:labels, username %>"></asp:Label>
                                        </td>
                                        <td style="width: 25%;" valign="top">
		     ...
		     <tr>
                 <td style="width: 25%;" valign="top">
                     <asp:Label ID="Label15" runat="server" Text="<%$ Resources:labels, taikhoanmacdinh %>"></asp:Label>
                 </td>
                 <td style="width: 25%;" valign="top">
                     <asp:DropDownList ID="ddlNDC2DefaultAcctno" runat="server">
                     </asp:DropDownList>
                 </td>
             </tr>
                                </table>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                            ...
                            <div style="text-align: right;">
                                <asp:Button ID="btnThemQuyenLevel2" runat="server"
                                    OnClick="btnThemQuyenLevel2_Click" OnClientClick="return validate3();"
                                    Text='<%$ Resources:labels, them %>' Width="170px" />
                                &nbsp;
        <asp:Button ID="btnHuyL2" runat="server" OnClick="btnHuyL2_Click" Text="<%$ Resources:labels, delete %>" />
                                &nbsp;
        <asp:Button ID="btnResetLevel2" runat="server" OnClick="btnResetLevel2_Click"
            Text="<%$ Resources:labels, themmoi %>" />
                            ...
                            <div id="divResultNguoiUyQuyen" style="margin-top: 20px; height: 150px; overflow: auto;">
                                ...
                                <asp:GridView ID="gvResultLevel2" runat="server"
                                    AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC"
                                    BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%" PageSize="5"
                                    OnPageIndexChanging="gvResultLevel2_PageIndexChanging"
                                    OnRowDeleting="gvResultLevel2_RowDeleting">
                                    <RowStyle ForeColor="#000066" />
                                    <Columns>
                                        <asp:BoundField HeaderText="<%$ Resources:labels, nguoidung %>" DataField="colFullName" />
                                        <asp:BoundField DataField="colIBUserName" HeaderText="<%$ Resources:labels, username %>" />
        ...
        <div class="tabbertab">
            <h2><%=Resources.labels.thongtinnguoiquantrihethong %></h2>
            <p>
                    ...
                    <div class="divGetInfoCust">
                        ...
                        <asp:Panel ID="UpdatePanel1" runat="server">
                            ...
                            <table class="style1" cellspacing="0" cellpadding="5">
                                <tr>
                                    <td>
                                        <asp:Label ID="Label19" runat="server" Text="<%$ Resources:labels, administratorcode %>"></asp:Label>
                                        &nbsp;*
                                    </td>
                                    <td>
                                        ...
                                        <asp:UpdateProgress ID="UpdateProgress5" DisplayAfter="0"
                                            runat="server">
                                            <ProgressTemplate>
                                                <img alt="" src="widgets/SEMSCustomerList/Images/ajaxloader.gif" style="width: 16px; height: 16px;" />
                                                <%=Resources.labels.loading %>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <asp:Label ID="Label81" runat="server" Text="<%$ Resources:labels, capbac %>" Visible="false"></asp:Label>
                                    </td>
                                    <td>
    ...
    //]]></script>
                    ...
                    <div id="div4" style="margin-top: 10px;">
                        <div class="divGetInfoCust">
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <td style="width: 25%;">
                                        <asp:RadioButton ID="radAllAccountQT" Checked="true" GroupName="AccInfoQT"
                                            runat="server" Text="<%$ Resources:labels, tatcataikhoan %>" onClick="enableACQT();" />
                                    </td>
                                    <td style="width: 25%;"></td>
                                    <td style="width: 25%;">
                                        <asp:RadioButton ID="radAccountQT" GroupName="AccInfoQT" runat="server"
                                            Text="<%$ Resources:labels, theotaikhoan %>" onClick="enableAQT();" />
                                    </td>
                                    <td style="width: 25%;">
                        ...
                        <div id="dhtmlgoodies_tabViewCTK">
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="Table9" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" style="width: 25%;">
                                            <asp:TextBox ID="txtIBUserNameQT" runat="server"></asp:TextBox>
                                        </td>
                                        <td rowspan="2" style="width: 50%;">
                                            <div style="width: 100%; height: 150px; overflow: auto;">
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="Table10" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        <td style="width: 20%;" valign="top">
                                            <asp:CheckBox ID="cbQTHTTKMD" runat="server" Text="<%$ Resources:labels, sudungmacdinh %>" />
                                        </td>
                                        <td valign="top">&nbsp;</td>
                                    </tr>
                                </table>
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="Table11" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        <td style="width: 25%; height: 25px" valign="top">
                                            <asp:Label ID="Label98" runat="server" Text="<%$ Resources:labels, username %>"></asp:Label>
                                        </td>
                                        <td style="width: 25%;" valign="top">
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="Table12" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        <td style="width: 25%;" valign="top">
                                            <asp:Label ID="Label101" runat="server" Text="<%$ Resources:labels, username %>"></asp:Label>
                                        </td>
                                        <td style="width: 25%;" valign="top">
                                    ...
                                    <tr>
                                        <td style="width: 25%;" valign="top">
                                            <asp:Label ID="Label6" runat="server" Text="<%$ Resources:labels, taikhoanmacdinh %>"></asp:Label>
                                        </td>
                                        <td style="width: 25%;" valign="top">
                                            <asp:DropDownList ID="ddlQTHTDefaultAcctno" runat="server">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                        <ContentTemplate>
                            <div style="text-align: right;">
                                &nbsp;
        <asp:Button ID="btnThemNQT" runat="server" Text='<%$ Resources:labels, them %>'
            Width="170px" OnClick="btnThemNQT_Click"
            OnClientClick="return validate4();" />
                                &nbsp;
        <asp:Button ID="btnHuyQTHT" runat="server" OnClick="btnHuyQTHT_Click"
            Text="<%$ Resources:labels, delete %>" />
                                &nbsp;
                            </div>
                            <asp:Label runat="server" ID="lblAlertQTHT" ForeColor="Red"></asp:Label>
                            <div id="div4" style="margin-top: 20px; width: 100%; height: 150px; overflow: auto;">

                                <asp:GridView ID="gvResultQuanTri" runat="server"
                                    AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC"
                                    BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%" OnPageIndexChanging="gvResultQuanTri_PageIndexChanging"
                                    PageSize="5" OnRowDeleting="gvResultQuanTri_RowDeleting">
                                    <RowStyle ForeColor="#000066" />
                                    <Columns>
                                        <asp:BoundField HeaderText="<%$ Resources:labels, nguoidung %>" DataField="colFullName" />
                                        <asp:BoundField DataField="colIBUserName" HeaderText="<%$ Resources:labels, username %>" />
                        ...
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="btnThemNQT" EventName="Click" />
                        </Triggers>
                    </asp:UpdatePanel>
        ...
        <div class="tabbertab">
            ...
            <p>
                ...
                <asp:Panel ID="Panel3" runat="server">
                            ...
                            <ContentTemplate>
                                <table class="style1" cellspacing="0" cellpadding="5">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtReFullNameS" Enabled="false" runat="server"></asp:TextBox>
                                        </td>
                                        <td>
                                ...
                                <table id="tblIB" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" style="width: 25%;">
                                            ...
                                            <asp:RadioButton ID="rbGenerateS" runat="server" GroupName="rbUserNameS" Checked="True"
                                                ClientIDMode="Static" />
                                            <asp:TextBox ID="txtIBGenUserNameS" runat="server"></asp:TextBox>
                                            <br />
                                            <asp:RadioButton ID="rbTypeS" runat="server" GroupName="rbUserNameS" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtIBTypeUserNameS" runat="server"></asp:TextBox>
                    ...
                    <asp:UpdateProgress ID="UpdateProgress10" runat="server" DisplayAfter="0" AssociatedUpdatePanelID="UpdatePanel2">
                        <ProgressTemplate>
                            <img alt="" src="widgets/SEMSCustomerList/Images/ajaxloader.gif" style="width: 16px; height: 16px;" />
                            <%=Resources.labels.loading %>
                        </ProgressTemplate>
                            ...
                            <table class="style1" cellspacing="0" cellpadding="5">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:UpdateProgress ID="UpdateProgress11" DisplayAfter="0"
                                            runat="server">
                                            <ProgressTemplate>
                                                <img alt="" src="widgets/SEMSCustomerList/Images/ajaxloader.gif" style="width: 16px; height: 16px;" />
                                                <%=Resources.labels.loading %>
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="tbllv4IB" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" style="width: 25%;">
                                            <asp:RadioButton ID="rblv4Generate" runat="server" GroupName="rblv4UserName" Checked="True"
                                                ClientIDMode="Static" />
                                            <asp:TextBox ID="txtlv4IBGenUserName" runat="server"></asp:TextBox>
                                            <br />
                                            <asp:RadioButton ID="rblv4Type" runat="server" GroupName="rblv4UserName" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtlv4IBTypeUserName" runat="server"></asp:TextBox>
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="tbllv4SMS" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <asp:Label ID="Label102" runat="server" Text="<%$ Resources:labels, warningoneaccountononesmsrole %>" Style="color: red"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <table class="style1" cellspacing="0" cellpadding="5">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:UpdateProgress ID="UpdateProgress13" DisplayAfter="0"
                                            runat="server">
                                            <ProgressTemplate>
                                                <img alt="" src="widgets/SEMSCustomerList/Images/ajaxloader.gif" style="width: 16px; height: 16px;" />
                                                <%=Resources.labels.loading %>
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="tbllv5IB" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" style="width: 25%;">
                                            <asp:RadioButton ID="rblv5Generate" runat="server" GroupName="rblv5UserName" Checked="True"
                                                ClientIDMode="Static" />
                                            <asp:TextBox ID="txtlv5IBGenUserName" runat="server"></asp:TextBox>
                                            <br />
                                            <asp:RadioButton ID="rblv5Type" runat="server" GroupName="rblv5UserName" ClientIDMode="Static" />
                                            <asp:TextBox ID="txtlv5IBTypeUserName" runat="server"></asp:TextBox>
                            ...
                            <div class="dhtmlgoodies_aTab">
                                <table id="tbllv5SMS" class="tblVDC" cellspacing="0" cellpadding="4">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <asp:Label ID="Label103" runat="server" Text="<%$ Resources:labels, warningoneaccountononesmsrole %>" Style="color: red"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </div>
...
<asp:Panel ID="pnCorpMatrix" runat="server"></asp:Panel>

<asp:Panel runat="server" ID="pnLuu">
    <div style="text-align: center; padding-top: 10px;">
        <asp:Button ID="btnCustSave" runat="server" OnClick="btnCustSave_Click"
            OnClientClick="return validate4();" Text="<%$ Resources:labels, save %>" Width="69px" />
        &nbsp;
...
<asp:HiddenField ID="hidCFcodeS" runat="server" />
...
<script type="text/javascript">
    function CheckOtherIsCheckedByGVID(rb) {
        ...
        parent = document.getElementById("<%= gvCustomerList.ClientID %>");
    ...
    function ValidateRadioButton(sender, args) {
        var gv = document.getElementById("<%= gvCustomerList.ClientID %>");
...
<script>
    ...
    function SetUserNameL2(custcode, custtype, length) {
        var date = new Date();
        var a = ticks(date).toString().length - 11;
        var b = length - ((custcode + custtype).length);
        var c = 10 - (custcode.length);

        var un = custcode + custtype + ticks(date).toString().substring(a, a + b) + "6";
