<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSContractListCorp_Delete_Widget" %>
...
<div style="text-align:center; padding-top:10px;">
    <asp:Button ID="btsaveandcont" runat="server" onclick="btsaveandcont_Click" 
        Text="<%$ Resources:labels, close %>" Width="71px" />
&nbsp;
