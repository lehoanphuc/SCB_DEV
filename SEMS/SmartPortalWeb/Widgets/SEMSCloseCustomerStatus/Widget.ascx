<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSCloseCustomerStatus_Widget" %>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-hdr">
                        <h2>
                            <%=Resources.labels.CloseCustomerStatus%>
                        </h2>
                    </div>
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <asp:TextBox ID="txtFullName" CssClass="form-control" MaxLength="50"  ReadOnly="true" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
