<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSTownShip_Delete_Widget" %>
<div class="subheader">
    <h1 class="subheader-title">
        <%=Resources.labels.xoathongtinquanhuyen %>
    </h1>
</div>
<div class="row">
    <div class="col-sm-12">
        <div class="panel">
            ...
            <div class="panel-container">
                <div class="panel-content text-center">
                    <div class="row">
                        <div class="col-sm-12">
                            <asp:Label ID="lblError" runat="server" Text="<%$ Resources:labels, banchacchanmuonxoaquanhuyennaykhong %>"></asp:Label>
                        </div>
                    </div>
                </div>
