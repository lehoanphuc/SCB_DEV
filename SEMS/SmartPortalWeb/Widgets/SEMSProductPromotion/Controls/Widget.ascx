<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSProductPromotion_Controls_Widget" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
                                    ...
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:TextBox ID ="txtPromotionName" runat="server" CssClass="form-control" onkeyup="this.value=this.value.replace(/[^a-zA-Z0-9 ]/g, '')" ></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:DropDownList ID="ddlProduct" CssClass="form-control select2 " runat="server" OnSelectedIndexChanged="ddlFeeType_OnChange">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:DropDownList ID="ddlPromotionSide" CssClass="form-control select2 " runat="server" OnSelectedIndexChanged ="ddlPromotionSide_SelectedIndexChanged" >
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:DropDownList ID="ddlStatus" Enabled="False" CssClass="form-control select2 " runat="server">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:DropDownList ID="ddlPromotionType" OnSelectedIndexChanged="ddlPromotionType_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control select2 " runat="server">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class ="row">
                                    ...
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:TextBox ID="txtdiscountdes" CssClass="form-control2" TextMode="MultiLine" onkeyup="ValidateLimit(this,'255');" onkeyDown="ValidateLimit(this,'255');" onpaste="ValidateLimit(this,'255');" onChange="ValidateLimit(this,'255');" onmousedown="ValidateLimit(this,'255');" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-2 col-xs-12"></div>
                        ...
                        <div class="panel-container">
                            <div class="panel-content form-horizontal p-b-0">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label required">From time</label>
                                            <div class="col-sm-8 col-xs-12">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label required">To time</label>
                                            <div class="col-sm-8 col-xs-12">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <label class="col-sm-5 col-xs-12 control-label required ">Fixed promotion amount</label>
                                            <div class="col-sm-6 col-xs-12">
                            ...
                            <div id="divResult">
                                <asp:GridView ID="gvDiscountDetails" CssClass="table table-hover" runat="server" BackColor="White"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Fixed promotion amount">
                                            <ItemTemplate>
                                                <asp:Label ID="lblfixedDiscount" runat="server"></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Promotion rate">
                                            <ItemTemplate>
                                ...
                                <div class="row">
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <label class="col-sm-4 col-xs-12 control-label required">Pay side</label>
                                            <div class="col-sm-8 col-xs-12">
                                    ...
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:DropDownList ID="ddlShareType" CssClass="form-control select2" Width="100%" OnTextChanged="ddlShareType_OnTextChanged" AutoPostBack="True" runat="server">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-2 col-xs-12">
                                        <div class="form-group">
                                            <div class="col-sm-12 col-xs-12">
                                                <asp:Button ID="btnsaveconnect" runat="server" Text="<%$ Resources:labels, them %>" CssClass="btn btn-primary" OnClick="btnSaveDetailsCollect_Click" OnClientClick="return validate();" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="divResult">
                                <asp:GridView ID="gvDiscountCollect" CssClass="table table-hover" runat="server" BackColor="White"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Pay site">
                                            <ItemTemplate>
        ...
        <div class="panel-content div-btn rounded-bottom border-faded border-left-0 border-right-0 border-bottom-0 text-muted">
            ...
            <asp:Button ID="btClone" CssClass="btn btn-primary" runat="server" Text="Clone" OnClick="btClone_OnClick" OnClientClick="Loading();" />
        </div>
