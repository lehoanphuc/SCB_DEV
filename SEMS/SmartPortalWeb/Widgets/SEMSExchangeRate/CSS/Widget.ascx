...
<div class="al">
<span>Danh sách giao dịch chờ duyệt</span><br />
...
<!--chi tiet giao dich -->
    <div class="block1">            	 
                    ...
                    <div style="padding-left:5px; padding-top:5px; padding-bottom:5px;">
                        <asp:Button ID="Button1" runat="server" Text="<%$ Resources:labels, duyet %>" 
                            />
                    &nbsp;
                    ...
                    <div class="content">
                        ...
                        <asp:TemplateField>
                            ...
                            <asp:BoundField DataField="Mota" HeaderText="<%$ Resources:labels, mota %>">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
