<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSFDProduct_Delete_Widget" %>
...
<div id="divCustHeader">
    ...
    <%=Resources.labels.xoathongtinfdproduct%>
</div>
        ...
        <tr>
            <td align="center" class="style2">
                <asp:Label ID="Label1" runat="server" 
                    Text="<%$ Resources:labels, banchacchanmuonxoasanphamtkonline %>"></asp:Label>
            </td>
