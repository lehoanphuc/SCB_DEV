...
public partial class Widgets_SEMSAccountOfGroupDefinition_Delete_Widget : WidgetBase
{
    string IPCERRORCODE = "";
    string IPCERRORDESC = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        lblError.Text = Resources.labels.bancochacchanmuonhuykhong + " " + GetParamsPage(IPC.ID)[0].Trim();
    }
