<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_KYCConsumer_Controls_Widget" %>
                        ...
                        <div class="panel-content form-horizontal p-b-0">
                            <asp:Panel ID="pnCustInfo" runat="server">
                                <div class="row" style="margin-left: 2%; margin-right: 2%">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label required"><%=Resources.labels.customername %></label>
                                            <div class="col-sm-8">
                                                <asp:TextBox ID="txtConsumerName" CssClass="form-control" IsRequired="true" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
