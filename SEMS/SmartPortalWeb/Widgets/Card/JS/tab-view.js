...
************************************************************************************************************/
	...
	function showTab(parentId,tabIndex)
	{
		...
		if(activeTabIndex[parentId]>=0){
			...
			img.src = 'widgets/SEMSCustomerList/images/tab_right_inactive.gif';
		...
		img.src = 'widgets/SEMSCustomerList/images/tab_right_active.gif';
	...
	function rolloverTab()
	{
		if(this.className.indexOf('tabInactive')>=0){
			...
			img.src = 'widgets/SEMSCustomerList/images/tab_right_over.gif';
		}
	...
	function initTabs(mainContainerID,tabTitles,activeTab,width,height,closeButtonArray,additionalTab)
	{
		...
		for(var no=0;no<tabTitles.length;no++){
			...
			if(closeButtonArray[no]){
				...
				closeButton.src = 'widgets/SEMSCustomerList/images/close.gif';
	...
	function removeAll(mainContainerID) {
	    if (activeTabIndex[parentId] > 0) {
	        for (var no = 0; no <= activeTabIndex[parentId]; no++) {
	            var parentId = 'tabView' + mainContainerID + tabIndex;
	            var tabLable = 'tabTab' + mainContainerID + activeTabIndex[parentId];
	            deleteTab(tabLable, no, parentId);
	        }
	    }
