        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                <div class="panel">
                    <div class="panel-hdr">
                        <h2>
                            <%=Resources.labels.thongtinphiotc%>
                        </h2>
                    </div>
                                    ...
                                    <div class="col-sm-6 col-xs-12 hidden">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:DropDownList ID="ddlProductType" CssClass="form-control select2" Width="100%"  runat="server">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xs-12">
                                       ...
                                       <div class="col-sm-6 col-xs-12 hidden">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:DropDownList ID="ddlContractLevel" CssClass="form-control select2 infinity" Width="100%" runat="server">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
