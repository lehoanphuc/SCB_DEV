<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SMSNOTIFYCATIONFEEDelete_Widget" %>
...
<div id="divCustHeader">
    ...
    <%=Resources.labels.xoasmsnotifyfee %>
        ...
        <tr>
            <td align="center" class="style2">
                <asp:Label ID="Label1" runat="server" 
                    Text="<%$ Resources:labels, banchacchanmuonxoasmsnotifyfee %>"></asp:Label>
        ...
        <table class="style1" cellspacing="0" cellpadding="5">
            <tr>
                <td align="center" class="style3">
                 <asp:Label runat="server" ID="lblError" ForeColor="Red" Text="<%$ Resources:labels, xoasmsnotifyfeethanhcong %>"></asp:Label>
                </td>
