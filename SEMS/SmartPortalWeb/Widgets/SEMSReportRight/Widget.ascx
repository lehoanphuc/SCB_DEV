<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_ReportRight_Widget" %>
                ...
                <table class="style1" cellspacing="1" cellpadding="3">
                    ...
                    <tr>
                        <td valign="top" style="width: 30%; text-align: right;">
                            <asp:Label ID="Label3" runat="server" Text='<%$ Resources:labels, report %>'></asp:Label>
                        </td>
                        <td>
