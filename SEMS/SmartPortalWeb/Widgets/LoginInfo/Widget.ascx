...
--%>                <a href='<%= SmartPortal.Common.Encrypt.EncryptURL(System.Configuration.ConfigurationManager.AppSettings["changepasswordlink"]) %>'><%= Resources.labels.changepassword %></a>
        </td>
    </tr>
</table>