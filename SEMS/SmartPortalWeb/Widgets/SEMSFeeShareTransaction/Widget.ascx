        ...
        <div id="divSearch">
            <div class="subheader">
                <h1 class="subheader-title">
                    <%=Resources.labels.TransactionShareFee %>
                </h1>
            </div>
                                ...
                                <div class="collapse in" id="AdvanceSearch">
                                    <div class="panel-content form-horizontal p-b-0" style="display: block;">
                                        <div class="row" style="margin-left: 2%">
                                            <div class="col-sm-5">
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label"><%=Resources.labels.TransactionName %></label>
                                                    <div class="col-sm-8">
                                                        <asp:DropDownList ID="ddlTransactionName" CssClass="form-control select2" Style="width: 100%;"  runat="server"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-1">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7 col-xs-12">
                                                        <asp:DropDownList ID="ddlFeeShareCode" CssClass="form-control select2 infinity" runat="server" AutoPostBack="true" >
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <asp:Panel ScrollBars="Auto" runat="server">
                    <asp:Repeater runat="server" ID="rptData" OnItemCommand="rptData_ItemCommand">
                        ...
                        <ItemTemplate>
                            <tr>
                                <td class="tr-boder">
                                    <input name="item1" class="check" value="<%#Eval("transCode")%>" onclick="ConfigCheckbox(this)" type="checkbox">
                                </td>
                                <td class="action tr-boder">
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("transCode")%>' CommandName='<%#IPC.ACTIONPAGE.DETAILS%>' OnClientClick="Loading();"><%#Eval("transName") %></asp:LinkButton>
                                </td>
                                <td class="tr-boder"><%#Eval("trantype") %></td>
                                <td class="tr-boder"><%#Eval("FeeShareCode") %></td>
                                <td class="tr-boder"><%#Eval("FeeShareName") %></td>

                                <td class="tr-boder">
                                    <asp:LinkButton runat="server" class="btn btn-primary" CommandArgument='<%#Eval("transCode")%>' CommandName='<%#IPC.ACTIONPAGE.EDIT%>'>Edit</asp:LinkButton>
                                </td>
                                <td class="tr-boder">
                                    <asp:LinkButton runat="server" class="btn btn-secondary" CommandArgument='<%#Eval("transCode")%>' CommandName='<%#IPC.ACTIONPAGE.DELETE%>' OnClientClick="return ConfirmDelete('Are you sure you want to delete this entry?');">Delete</asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
