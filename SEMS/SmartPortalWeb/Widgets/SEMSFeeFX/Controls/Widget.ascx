<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSFeeFX_Controls_Widget" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
                        ...
                        <div class="panel-container">
                            <div class="panel-content form-horizontal p-b-0">
                                ...
                                <div class="row">
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label required"><%=Resources.labels.fromcurrency %></label>
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:DropDownList ID="ddlCCYIDFrm" CssClass="form-control select2 infinity" runat="server"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-5 col-xs-12">
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label"><%=Resources.labels.tocurrency %></label>
                                            <div class="col-sm-8 col-xs-12">
                                                <asp:DropDownList ID="ddlCCYIDTo" CssClass="form-control select2 infinity" runat="server">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-2 col-xs-12">
                                        <div class="form-group">
                                            <div class="col-sm-12 col-xs-12">
                                                <asp:Button ID="btnSearch" runat="server" Text="<%$ Resources:labels, search %>" CssClass="btn btn-primary" OnClick="btnSearch_Click"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div id="divResult">
                <asp:GridView ID="gvAppTransDetailsList" CssClass="table table-hover" runat="server" BackColor="White"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:labels, billername %>" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="lblBillerName" runat="server"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="<%$ Resources:labels, fromcurrency %>">
                            <ItemTemplate>
                                <asp:Label ID="lblFromCurrency" runat="server"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="<%$ Resources:labels, tocurrency %>">
                            <ItemTemplate>
                                <asp:Label ID="lblToCurrency" runat="server"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
        ...
        <asp:Panel ID="pnWarning" runat="server" Visible="false">
