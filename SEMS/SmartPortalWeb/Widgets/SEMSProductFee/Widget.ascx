<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSProductFee_Widget" %>
    ...
    <ContentTemplate>
        <div class="subheader">
            <h1 class="subheader-title">
                <%=Resources.labels.quanlyphichosanpham %>
            </h1>
        </div>
        <div class="loading">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 col-xs-12">
                                                        <asp:DropDownList ID="ddlccyid" CssClass="form-control select2 infinity" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="ddlccyid_OnSelectedIndexChanged" runat="server">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">                                         
                                            <div class="col-sm-6 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 col-xs-12">
                                                        <asp:DropDownList ID="ddlfeetype" CssClass="form-control select2" Width="100%" runat="server">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div id="divResult" runat="server">
            ...
            <asp:GridView ID="gvProductList" CssClass="table table-hover" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" Width="100%" AutoGenerateColumns="False" OnRowDataBound="gvProductList_RowDataBound" PageSize="15" OnRowCommand="gvProductList_RowCommand" OnRowDeleting="gvProductList_RowDeleting">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:labels, tensanpham%>">
                        <ItemTemplate>
                            <asp:LinkButton ID="lblProductName" runat="server" CommandName='<%#IPC.ACTIONPAGE.DETAILS %>' CommandArgument='<%#Eval("ProductID")+"|"+ Eval("TranCode")+"|"+ Eval("FEEID")+"|"+ Eval("CCYID")+"|"+ Eval("ContractLevelId")+"|"+ Eval("Islocal")%>' OnClientClick="Loading();"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:labels, loaiphi %>">
                        <ItemTemplate>
                            <asp:Label ID="labelFeeType" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$ Resources:labels, FeeShareCode %>" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="lblFeeShareCode" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="<%$ Resources:labels, edit %> ">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbEdit" runat="server" CssClass="btn btn-primary" CommandName='<%#IPC.ACTIONPAGE.EDIT %>' CommandArgument='<%#Eval("ProductID")+"|"+ Eval("TranCode")+"|"+ Eval("FEEID")+"|"+ Eval("CCYID")+"|"+ Eval("ContractLevelId")+"|"+ Eval("Islocal")%>' OnClientClick="Loading();">Edit</asp:LinkButton>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="<%$ Resources:labels, delete %>">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbDelete" runat="server" CssClass="btn btn-secondary" CommandName='<%#IPC.ACTIONPAGE.DELETE %>' CommandArgument='<%#Eval("ProductID")+"|"+ Eval("TranCode")+"|"+ Eval("FEEID")+"|"+ Eval("CCYID")+"|"+ Eval("ContractLevelId")+"|"+ Eval("Islocal")%>' OnClientClick="Loading(); return Confirm();">Delete</asp:LinkButton>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                </Columns>
