...
public partial class Widgets_Language_Delete_Widget : WidgetBase
{
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["tdec"], "Widgets_Theme_Delete_Widget", "btnDelete_Click", bex.ToString(), Request.Url.Query);
