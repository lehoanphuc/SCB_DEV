<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_SEMSProductDelete_Widget" %>
...
<div id="divCustHeader">
    <img alt="" src="widgets/SEMSIBMBNOTIFICATION/Images/system_config_services.png" style="width: 30px; height: 32px; margin-bottom:10px;" align="middle" /> 
   <%=Resources.labels.deletenotifyIBMB %>
        ...
        <tr>
            <td align="center" class="style2">
                <asp:Label ID="Label1" runat="server" 
                    Text="<%$ Resources:labels, banchacchanmuonxoa %>"></asp:Label>
            </td>
        ...
        <table class="style1" cellspacing="0" cellpadding="5">
            <tr>
                <td align="center" class="style3">
                 <asp:Label runat="server" ID="lblError" ForeColor="Red" Text="<%$ Resources:labels, xoathanhcong %>"></asp:Label>
                </td>
