...
namespace SmartPortal.SEMS
{
    public class Bank
    {
        ...
        public DataSet LoadCCYIDBYBANKID(string bankID, ref string errorCode, ref string errorDesc)
        {
            try
            {
                ...
                //add key into input
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "GETCCYIDLOAD");
                ...
                hasInput.Add(SmartPortal.Constant.IPC.TRANDESC, "LOAD CCYID");
