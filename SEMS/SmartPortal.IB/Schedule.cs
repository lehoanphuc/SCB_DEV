...
namespace SmartPortal.IB
{
    public class Schedule
    {
        ...
        public DataSet ApproveSchedule(string userID,string scheid, string schetype, string schename, string desc, string trancode,string amount, string ccyid,string sender, string receiver, ref string errorCode,ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
