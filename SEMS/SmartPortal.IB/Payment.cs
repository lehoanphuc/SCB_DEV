...
namespace SmartPortal.IB
{
    public class Payment
    {
        ...
        public DataTable GetMis(string corpid, string serviceid, string email, string fromdate, string todate, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
        ...
        public Hashtable GetAmountFromHUB(string corpID,string serviceID, string accountNumber, string refval1, string refval2,string refval3, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                //add key into input
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "IB000609");
                hasInput.Add(SmartPortal.Constant.IPC.SOURCEID, SmartPortal.Constant.IPC.SOURCEIBVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.SOURCETRANREF, SmartPortal.Constant.IPC.SOURCETRANREFVALUE);
                hasInput.Add(SmartPortal.Constant.IPC.CORPID, corpID);
                hasInput.Add(SmartPortal.Constant.IPC.SERVICEID, serviceID);
