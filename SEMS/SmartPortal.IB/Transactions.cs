...
namespace SmartPortal.IB
{
    public class Transactions
    {
        ...
        public DataSet GetAllLimitUser(string userID, string trancode, string ccyid, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
        ...
        public DataSet InsertCorpUserLimit(string userid, string trancode, string ccyid, string tranlm, string countlm, string totallmday, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
        ...
        public DataSet UpdateCorpUserLimit(string userid, string trancode, string ccyid, string tranlm, string countlm, string totallmday, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
        ...
        public DataSet SearchCorpUserApproveProcess(string ApptranID, string trancode, string contractno, string ccyid, string amount, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
        ...
        public DataSet BatchTransfer(DataTable batchTable, string tranDesc, string userID, string Account, string TotalAmount, string authenType, string authenCode, string ccyid, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
        ...
        //QuanNN
        public DataSet GetApprovalTranByTranID(string tranID, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
