...
using InterbankTransferService;
...
namespace InterbankTransferService
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        c.GroupActionsBy(apiDesc => {
                            ...
                            return attr?.DisplayName ?? apiDesc.HttpMethod.ToString();
                        });
                        ...
                        c.OperationFilter<CusAuthenSwagger>();
                        c.OperationFilter<CustomExamplesOperationFilter>();
                ...
                .EnableSwaggerUi(c =>
                    {
                        ...
                        c.InjectJavaScript(thisAssembly, "InterbankTransferService.CustomContent.JavaScript.js");
        ...
        {
            return System.AppDomain.CurrentDomain.BaseDirectory + @"WebService.xml";
        }
