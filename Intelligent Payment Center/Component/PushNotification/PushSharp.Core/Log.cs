...
namespace PushSharp.Core
{
    ...
    public static class Log
    {
        ...
        public static void Write(LogLevel level, string msg, params object[] args)
        {
            ...
            if (ConfigurationManager.AppSettings["DebugLog"] != null && ConfigurationManager.AppSettings["DebugLog"].Equals("Y"))
                ProcessLog.LogInformation($"{level.ToString()}=={msg}=={string.Join("/", Array.ConvertAll(args, item => item.ToString()))}");
        }
