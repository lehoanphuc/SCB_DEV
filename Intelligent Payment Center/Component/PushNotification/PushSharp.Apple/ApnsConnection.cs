    ...
    public class ApnsConnection
    {
        ...
        {            
            ...
            try {
                ...
                throw new ApnsConnectionException ("Failed to Connect, check your firewall settings!" + ex.Message, ex);
            }
            ...
            if (Configuration.SkipSsl) {
                ...
                try {
                    var tls = System.Security.Authentication.SslProtocols.Tls12 | System.Security.Authentication.SslProtocols.Tls11 | System.Security.Authentication.SslProtocols.Tls;
