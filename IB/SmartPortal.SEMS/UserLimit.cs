...
namespace SmartPortal.SEMS
{
    public class UserLimit
    {
        ...
        public DataSet GetCMUserByCondition(string userID, string fullName, string contractNo, string transaction, string currency, ref string errorCode, ref string errorDesc)
        {
            try
            {
        ...
        #region GET CM USER
        public DataSet GetCMUser(string userID, string fullName, string contractNo, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
