...
namespace SmartPortal.SEMS
{
    public class Notification
    {
        ...
        public DataSet GetPushNotification(string ID, string name, string notificationType, string type, string sendType, string status, ref string errorCode, ref string errorDesc)
        {
            try
            {
                Hashtable hasInput = new Hashtable();
        ...
        public DataSet EditPushNotification(DataTable dtPN, DataTable drSchedule, DataTable dtDel, DataTable dtScheduleDay, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
        ...
        #endregion
        public DataSet ApprovePushNotification(string ID, string STATUS, ref string errorCode, ref string errorDesc)
        {
            try
            {
                Hashtable hasInput = new Hashtable();
