...
namespace SmartPortal.SEMS
{
    public class UserApprovalLimit
    {
        ...
        public DataSet GetCMUserApprovalByCondition(string userID, string fullName, string contractNo, string transaction, string currency, ref string errorCode, ref string errorDesc)
        {
            try
            {
