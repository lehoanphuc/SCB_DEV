...
namespace SmartPortal.SEMS
{
    public class Contract
    {
        ...
        public DataSet GetContractByCondition(string contractno, string custname, string usercreate, string createdate, string enddate, string contracttype, string status, string licenseid, string custcode, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
        ...
        public DataSet LoadContractForApprove(string contractno, string custname, string usercreate, string createdate, string enddate, string contracttype, string status, string BranchID, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
        ...
        public DataTable GetRoleByServiceAndContract(string serviceID, string contractNo)
        {
            ...
            iRead = DataAccess.GetFromDataTable("SEMS_GETROLEBYSERVICEANDCONTRACT", p1, p2);
        ...
        public DataSet GetAccount(string username, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
                ...
                //add key into input
                hasInput.Add(SmartPortal.Constant.IPC.IPCTRANCODE, "IB_GET_CTTYPE");
