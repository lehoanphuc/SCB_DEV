...
namespace SmartPortal.IB
{
    public class User
    {
        ...
        public DataTable UpdateChangeLanguage(string userid, string langid, string uuid)
        {
            SqlParameter p1 = new SqlParameter();
            p1.ParameterName = "@userID";
            p1.Value = userid;
            ...
            return DataAccess.GetFromDataTable("IB_ChangeLoginLanguage", p1, p2,p3);
        }
        ...
        public DataSet CheckPhoneNumberNonWallet(string PhoneNo, ref string errorCode, ref string errorDesc)
        {
            try
            {
                //Show hastable result from IPC
