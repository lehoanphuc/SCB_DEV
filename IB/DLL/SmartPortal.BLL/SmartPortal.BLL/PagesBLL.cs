...
namespace SmartPortal.BLL
{
    public class PagesBLL
    {
        ...
        public DataTable GetAction_Page()
        {
            try
            {
                return DataAccess.GetFromDataTable("SMP_ActionLoad");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public static bool IBCheckPermitPageAction(string pageMain, string userID, string action)
        {
            {
                try
                {
                    ...
                    tblPermit = DataAccess.GetFromDataTable("IBPages_CheckPermitPageAction", p1, p2, p3);
