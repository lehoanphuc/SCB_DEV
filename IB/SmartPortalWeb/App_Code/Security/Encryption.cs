...
namespace SmartPortal.Security
{
    /// <summary>
    ...
    public static class Encryption
    {
        ...
        public static string Decrypt(String strData)
        {
            ...
            {
                strResult = "******";
                SmartPortal.Common.Log.RaiseError("Encryption", "Decrypt", System.Reflection.MethodBase.GetCurrentMethod().Name, "Error. Fail to generate key for decryption", "");
                return strResult;
            }
            ...
            {
                strResult = "******";
                SmartPortal.Common.Log.RaiseError("Encryption", "Decrypt", System.Reflection.MethodBase.GetCurrentMethod().Name, "Error. Input Data is not base64 encoded.", "");
                return strResult;
            }
            ...
            {
                strResult = "******";
                SmartPortal.Common.Log.RaiseError("Encryption", "Decrypt", System.Reflection.MethodBase.GetCurrentMethod().Name, "Error. Decryption Failed. Possibly due to incorrect Key or corrputed data", "");
                return strResult;
            }
        }
