...
<div class="th">
    <span><%=Resources.labels.transferunregisteredaccount %></span><br />
        ...
        <asp:Panel ID="pnTRF" runat="server" class="divcontent">
            ...
            <div class="content_table">
                <div class="row">
                    ...
                    <div class="col-xs-7 col-sm-4 line30">
                        <asp:TextBox ID="txtCreditName" runat="server"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-5 col-sm-4 right">
                    ...
                    <div class="col-xs-7 col-sm-4 line30">
                        <asp:TextBox ID="txtCreditNRIC" runat="server" MaxLength="18"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-5 col-sm-4 right">
                    ...
                    <div class="col-xs-7 col-sm-4 line30">
                        <asp:TextBox ID="txtCreditPhoneNo" runat="server" MaxLength="11"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-5 col-sm-4 right">
                    ...
                    <div class="col-xs-7 col-sm-4 line30">
                        <asp:TextBox ID="txtCreditAddr" runat="server" MaxLength="150" onkeyup="ValidateLimit(this,150);" onkeyDown="ValidateLimit(this,150);" onpaste="ValidateLimit(this,150);"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="handle">
        ...
        <asp:Panel ID="pnConfirm" runat="server" class="divcontent">
            ...
            <div class="content_table">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-7 col-sm-6 line30">
                        <asp:Label ID="lblCreditNRIC" runat="server"></asp:Label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-5 col-sm-6 right">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-7 col-sm-6 line30">
                        <asp:Label ID="lblCreditAddr" runat="server"></asp:Label>
                    </div>
                </div>
            </div>
            <div class="handle">
        ...
        <asp:Panel ID="pnResult" runat="server" class="divcontent">
            ...
            <div class="content_table">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-7 col-sm-6 line30">
                        <asp:Label ID="lblEndCreditNRIC" runat="server"></asp:Label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-5 col-sm-6 right">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-7 col-sm-6 line30">
                        <asp:Label ID="lblEndCreditAddr" runat="server"></asp:Label>
                    </div>
                </div>
            </div>
            <div class="handle">
            ...
            <div class="content_table">
                ...
                <div class="row">
                    <div class="col-xs-5 col-sm-6 right">
                        <span><%=Resources.labels.cashcode %></span>
                    </div>
                    <div class="col-xs-7 col-sm-6 line30">
                        <asp:Label ID="lblCashCode" Font-Bold="True" ForeColor="Red" runat="server"></asp:Label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-5 col-sm-6 right">
...
<script type="text/javascript">
    ...
    function validate() {
        ...
        if (!validateEmpty('<%=txtCreditNRIC.ClientID %>', "<%=Resources.labels.bannhapnrc %>")) {
            return false;
        }
        if (regNRC.test(document.getElementById('<%=txtCreditNRIC.ClientID %>').value.trim()) != true) {
            swalWarningFocus($('<%=txtCreditNRIC.ClientID %>'), "<%=Resources.labels.invalidnrc %>");
            return false;
        }
    ...
    function poponload() {
        testwindow = window.open("widgets/IBTransferNonAccount/print.aspx?cul=" + '<%=System.Globalization.CultureInfo.CurrentCulture.ToString()%>', "BienLai",
    ...
    function poponloadview() {
        testwindow = window.open("widgets/IBTransferNonAccount/viewprint.aspx?cul=" + '<%=System.Globalization.CultureInfo.CurrentCulture.ToString()%>', "BienLai",
            "menubar=1,scrollbars=1,width=500,height=650");
        testwindow.moveTo(0, 0);
        return false;
    }
