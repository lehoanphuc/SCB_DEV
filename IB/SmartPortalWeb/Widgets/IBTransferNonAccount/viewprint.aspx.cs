...
public partial class Widgets_IBTransferBAC1_print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            tmpl = SmartPortal.Common.ST.GetStringTemplate("IBTransferNonAccount", "TransferNonAccount");
            ...
            tmpl.SetAttribute("cashCode", hasPrint["cashCode"].ToString());
            ...
            tmpl.SetAttribute("nrcNumber", hasPrint["nrcNumber"].ToString());
