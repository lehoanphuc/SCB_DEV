...
var ddaccordion={
	...
	expandall:function(headerclass){ //PUBLIC function to expand all headers based on their shared CSS classname
		var $=jQuery
		var $headers=jQuery13('.'+headerclass)
	...
	toggleone:function(headerclass, selected, optstate){ //PUBLIC function to expand/ collapse a particular header
		var $=jQuery
		var $targetHeader=jQuery13('.'+headerclass).eq(selected)
		var $subcontent=jQuery13('.'+this.contentclassname[headerclass]).eq(selected)
	...
	jQuery13(document).ready(function($){
		...
		$('.'+config["headerclass"]).each(function(index){ //loop through all headers
			...
			if (jQuery13.inArray(needle, expandedindices)!=-1){ //check for headers that should be expanded automatically (convert index to string first)
