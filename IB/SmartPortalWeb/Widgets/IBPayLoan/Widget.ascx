<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_IBPayLoan_Widget" %>
<style type="text/css">
    .style11
    {
        width: 100%; 
...
<div class="block1">            	 
                    ...
                    <div class="handle">                    	
                    	Trả nợ vay từ tài khoản thanh toán
                    </div>                    
                    <div class="content">
                        <table class="style11" cellspacing="0" cellpadding="5">
                            ...
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label63" runat="server" Text="Số tiền gốc *"></asp:Label>
                                </td>
                                <td >
                            ...
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label66" runat="server" Text="Số tiền lãi *"></asp:Label>
                                </td>
                                <td >
                                    <asp:TextBox ID="txtAmount1" 
                                        onkeyup="ntt('ctl00_ctl15_txtAmount1','ctl00_ctl15_lblText1',event);" 
 ...
 <div class="block1">            	 
                    ...
                    <div class="content">
                        <table class="style11" cellspacing="0" cellpadding="5">
                            ...
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label22" runat="server" Text="Số tiền gốc"></asp:Label>
                                </td>
                                <td >
                            ...
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label67" runat="server" Text="Số tiền lãi"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label68" runat="server" Text="2.000.000 LAK"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label69" runat="server" Text="Tổng số tiền phải trả"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label70" runat="server" Text="4.000.000 LAK"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label71" runat="server" Text="Lãi cộng dồn"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label72" runat="server" Text="2.000.000 LAK"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label73" runat="server" Text="Lãi đến hạn"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label74" runat="server" Text="2.000.000 LAK"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label75" runat="server" Text="Lãi quá hạn"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label76" runat="server" Text="2.000.000 LAK"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
 ...
 <div class="block1">            	 
                    ...
                    <div class="content">
                        <table class="style11" cellspacing="0" cellpadding="5">
                            ...
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label11" runat="server" Text="Số tiền gốc"></asp:Label>
                                </td>
                                <td >
                            ...
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label13" runat="server" Text="Số tiền lãi"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label14" runat="server" Text="2.000.000 LAK"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label15" runat="server" Text="Tổng số tiền phải trả"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label16" runat="server" Text="4.000.000 LAK"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label17" runat="server" Text="Lãi cộng dồn"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label18" runat="server" Text="2.000.000 LAK"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label21" runat="server" Text="Lãi đến hạn"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label24" runat="server" Text="2.000.000 LAK"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label25" runat="server" Text="Lãi quá hạn"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label27" runat="server" Text="2.000.000 LAK"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label28" runat="server" Text="Diễn giải"></asp:Label>
                                </td>
                                <td >
                                    <asp:Label ID="Label29" runat="server" Text="Giải ngân vào TKTT"></asp:Label>
                                </td>                                
                            </tr>                            
                        </table>
                    </div>                
...
<script type="text/javascript">
    ...
    function validate()
    {
                    ...
                    {
                        if(validateMoney('<%=txtAmount1.ClientID %>','Bạn cần nhập số tiền hợp lệ'))
                        {
