...
public partial class Widgets_IBViewLogTransactions_print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            tmpl = SmartPortal.Common.ST.GetStringTemplate("IBCorpApprovedTransactions", "Viewlogen-US");
            ...
            tmpl.SetAttribute("approvalwf", hs["wf"].ToString());
            tmpl.SetAttribute("group", hs["gr"].ToString());
            tmpl.SetAttribute("approvaltrans", hs["th"].ToString());
