<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_Menu_Translate_Widget" %>
<link href="Widgets/Menu/Translate/CSS/StyleSheet.css" rel="stylesheet" type="text/css" />
...
<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"  
        ...
        ErrorMessage='<%$ Resources:labels, menutitlerequire %>' SetFocusOnError="True">
