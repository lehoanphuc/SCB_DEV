<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_WidgetHTMLManagement_View_Widget" %>
...
<div style="padding:5px 0px 5px 5px;">
    <img alt="" src="widgets/widgethtmlmanagement/view/images/add.gif" style="width: 16px; height: 16px" />
    <asp:LinkButton ID="lbAddPage" Text='<%$ Resources:labels, addwidgethtml %>' 
        runat="server" onclick="lbAddPage_Click"></asp:LinkButton>
    &nbsp;
    <img alt="" src="widgets/widgethtmlmanagement/view/images/action_delete.gif" style="width: 16px; height: 16px" /><asp:LinkButton ID="lbDeleteSelected" 
...
<table style="margin:5px auto 5px auto; width:100%;">
    <tr>
        <td>
            <asp:GridView ID="gvHTMLWidget" runat="server" AllowPaging="True" 
                AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" 
                ForeColor="#333333" GridLines="None" 
                 PageSize="15" Width="100%" onrowdatabound="gvHTMLWidget_RowDataBound" 
                onpageindexchanging="gvHTMLWidget_PageIndexChanging" 
                onsorting="gvHTMLWidget_Sorting" >
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <center><asp:Label ID="lblWidgetID" runat="server" Visible="false"></asp:Label></center>
                        </ItemTemplate>
                    </asp:TemplateField>                   
                    <asp:TemplateField HeaderText='<%$ Resources:labels, widget %>' SortExpression="WidgetTitle">
                        <ItemTemplate>
                            <img src="widgets/widgethtmlmanagement/view/images/htmlwidget.gif" />
                           <asp:HyperLink ID="hpWidgetTitle" runat="server"></asp:HyperLink>
                        </ItemTemplate>
                    </asp:TemplateField> 
...
<div style="padding:5px 0px 5px 5px;">
    <hr />
    <img alt="" src="widgets/widgethtmlmanagement/view/images/add.gif" style="width: 16px; height: 16px" />
    <asp:LinkButton ID="LinkButton1" Text='<%$ Resources:labels, addwidgethtml %>' 
        runat="server" onclick="lbAddPage_Click"></asp:LinkButton>
    &nbsp;
    <img alt="" src="widgets/widgethtmlmanagement/view/images/action_delete.gif" style="width: 16px; height: 16px" /><asp:LinkButton ID="LinkButton2" 
        Text='<%$ Resources:labels, deleteselected %>' runat="server" onclick="lbDeleteSelected_Click"  
        ></asp:LinkButton>
     &nbsp;
     <img alt="" src="widgets/pages/view/images/back.gif" style="width: 16px; height: 16px" />
