...
public partial class Widgets_WidgetHTMLManagement_Controls_Widget : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["sqlec"], "Widgets_WidgetHTMLManagement_Controls_Widget", "Page_Load", sex.Message, Request.Url.Query);
            SmartPortal.Common.Log.GoToErrorPage(System.Configuration.ConfigurationManager.AppSettings["sqlec"], Request.Url.Query);
        }
        catch (Exception ex)
        {
            SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["sysec"], "Widgets_WidgetHTMLManagement_Controls_Widget", "Page_Load", ex.Message, Request.Url.Query);
    ...
    protected void btnExit_Click(object sender, EventArgs e)
    {
        ...
        {
            //alert
            Response.Redirect(System.Configuration.ConfigurationManager.AppSettings["viewhtmlwidget"]);
        }
        else
        {
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        if (SmartPortal.Common.Encrypt.GetURLParam(System.Web.HttpContext.Current.Request.RawUrl)["wid"] == null)
        {
            ...
            {
                SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["htmlwidgetiec"], "Widgets_WidgetHTMLManagement_Controls_Widget", "btnSave_Click", bex.Message, Request.Url.Query);
            ...
            {
                SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["sqlec"], "Widgets_WidgetHTMLManagement_Controls_Widget", "btnSave_Click", sex.Message, Request.Url.Query);
                SmartPortal.Common.Log.GoToErrorPage(System.Configuration.ConfigurationManager.AppSettings["sqlec"], Request.Url.Query);
            }
            catch (Exception ex)
            {
                SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["sysec"], "Widgets_WidgetHTMLManagement_Controls_Widget", "btnSave_Click", ex.Message, Request.Url.Query);
                SmartPortal.Common.Log.GoToErrorPage(System.Configuration.ConfigurationManager.AppSettings["sysec"], Request.Url.Query);
            }
        ...
        else
        {
            ...
            {
                SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["htmlwidgetuec"], "Widgets_WidgetHTMLManagement_Controls_Widget", "btnSave_Click", bex.Message, Request.Url.Query);
