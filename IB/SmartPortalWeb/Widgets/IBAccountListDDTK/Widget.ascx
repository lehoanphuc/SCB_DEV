<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_IBAccountListDDTK_Widget" %>
...
<div class="al">
    <span><%=Resources.labels.danhsachtaikhoantietkiemkhongkyhan %></span><br />
    ...
    <asp:UpdatePanel runat="server">
        ...
        <ContentTemplate>
            ...
            <div class="divAcct">
                            ...
                            <div>
                                <div class="row">
                                    <div class="col-xs-2 col-md-1">
                                        <img alt="" src="<%#"Images/WidgetImage/act_DD.png" %>">
                                    </div>
                                    <div class="col-xs-10 col-md-5">
                                        <span><%#Eval("Total") %></span><br>
                                        <a href="<%#Eval("Detail") %>">View account detail</a>
                                    </div>
                                    <div class="col-xs-6 col-md-6 mb_hide" style="text-align: right; color: #64B5F6;">
                ...
                <asp:Label ID="ltrDDTK" runat="server" CssClass="bold" ForeColor="Red"></asp:Label>
