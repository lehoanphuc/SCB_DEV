<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_IBTransferInBAC1_Widget" %>
...
<div class="th">
    <span><%=Resources.labels.chuyenkhoancungchusohuu %></span><br />
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnTIB" runat="server" class="divcontent">
                ...
                <ContentTemplate>
                    ...
                    <div class="content_table">
                        <div class="row">
                            ...
                            <div class="col-xs-7 col-md-4 col-sm-6 line30">
                                <asp:DropDownList ID="ddlReceiverAccount" runat="server" OnSelectedIndexChanged="OnReceiverAccountChanged" AutoPostBack="true">
                                </asp:DropDownList>
                        ...
                        <div class="row" style="display: none">
                            <div class="col-xs-5 col-sm-4 right">
                                <asp:Label ID="Label33" runat="server" Text="<%$ Resources:labels, lasttransactiondate %>"></asp:Label>
                            </div>
                            <div class="col-xs-7 col-md-4 col-sm-6 line30">
                        ...
                        <div class="row">
                            <div class="col-xs-5 col-sm-4 right">
                                <asp:Label ID="Label37" runat="server" Text="<%$ Resources:labels, availablebalance %>"></asp:Label>
                            </div>
                            <div class="col-xs-7 col-md-4 col-sm-6 line30">
                                <asp:Label ID="lblAvailableBalr" runat="server"></asp:Label>
            ...
            <%--save template--%>
            <div class="handle">
                <asp:Label ID="Label6" runat="server" Text='<%$ Resources:labels, luunoidungchuyenkhoannaythanhmau %>'></asp:Label>
            </div>
            <div class="content_table">
                <div class="row">
                    <div class="col-xs-5 col-sm-4 right">
                        <asp:Label ID="Label9" runat="server" Text='<%$ Resources:labels, luuthanhmau %>'></asp:Label>
                    </div>
        ...
        <asp:Panel ID="pnConfirm" runat="server" class="divcontent">
            ...
            <div class="content_table">
                <div class="row">
                    <div class="col-xs-5 col-sm-6 right">
                        <asp:Label ID="Label36" runat="server" Text="<%$ Resources:labels, hotennguoinhantien %>"></asp:Label>
                    </div>
                    <div class="col-xs-7 col-sm-6 col-sm-6 line30">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-7 col-sm-6 col-sm-6 line30">
                        <asp:Label ID="lblBalanceReceiver" runat="server"></asp:Label>
                        &nbsp;<asp:Label ID="lblReceiverCCYID" runat="server" Text="ccyid"></asp:Label>
                    </div>
                </div>
            </div>
            <%--transaction information--%>
            <div class="handle">
                <asp:Label ID="Label22" runat="server" Text='<%$ Resources:labels, noidungchuyenkhoan %>'></asp:Label>
            </div>
            <div class="content_table">
                <div class="row">
                    <div class="col-xs-5 col-sm-6 right">
            ...
            <div class="button-group">
                <asp:Button ID="btnBackTransfer" runat="server" OnClick="btnBackTransfer_Click" CssClass="btn btn-warning" Text='<%$ Resources:labels, quaylai %>' />

                <asp:Button ID="btnApply" runat="server" OnClick="btnApply_Click" CssClass="btn btn-primary" Text='<%$ Resources:labels, xacnhan %>' />
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 col-sm-4 left">
                        <asp:Panel ID="pnSendOTP" runat="server">
                            <asp:Button ID="btnSendOTP" runat="server" CssClass="btn btn-primary btnSendOTP" OnClick="btnSendOTP_Click" Text="<%$ Resources:labels, send %>" />
        ...
        <asp:Panel ID="pnResultTransaction" runat="server" class="divcontent">
            ...
            <div class="content_table">
                ...
                <div class="row">
                    <div class="col-xs-5 col-sm-6 right">
                        <asp:Label ID="Label58" runat="server" Text='<%$ Resources:labels, sodusaukhighino %>'></asp:Label>
                    </div>
                    <div class="col-xs-7 col-sm-6 line30">
            ...
            <div class="handle">
                <asp:Label ID="Label24" runat="server" Text='<%$ Resources:labels, thongtinnguoinhantien %>'></asp:Label>
            </div>
            <div class="content_table">
                <div class="row">
                    <div class="col-xs-5 col-sm-6 right">
                ...
                <div class="row">
                    <div class="col-xs-5 col-sm-6 right">
                        <asp:Label ID="Label17" runat="server" Text='<%$ Resources:labels, sodusaukhighino %>'></asp:Label>
                    </div>
                    <div class="col-xs-7 col-sm-6 line30">
            ...
            <div class="handle">
                <asp:Label ID="Label25" runat="server" Text='<%$ Resources:labels, noidungchuyenkhoan %>'></asp:Label>
            </div>
            <div class="content_table">
                <div class="row">
                    <div class="col-xs-5 col-sm-6 right">
            ...
            <asp:Button ID="btnPrint" runat="server" OnClientClick="javascript:return poponload()"
                ...
                &nbsp;
            <asp:Button ID="btnNew" runat="server" Text='<%$ Resources:labels, lammoi %>' CssClass="btn btn-success" OnClick="Button6_Click" />
                <div class="clearfix"></div>
            </div>
        </asp:Panel>
        <!--end-->
        ...
        <script type="text/javascript">
            function poponload() {
                testwindow = window.open("widgets/IBTransferBAC1/print.aspx?cul=" + '<%=System.Globalization.CultureInfo.CurrentCulture.ToString()%>', "BienLai",
            ...
            function poponloadview() {
                testwindow = window.open("widgets/IBTransferBAC1/viewprint.aspx?cul=" + '<%=System.Globalization.CultureInfo.CurrentCulture.ToString()%>', "BienLai",
                    "menubar=1,scrollbars=1,width=500,height=650");
                testwindow.moveTo(0, 0);
                return false;
            }
            ...
            function validate() {
                ...
                if (!validateSameAccount('<%=ddlSenderAccount.ClientID%>', '<%=ddlReceiverAccount.ClientID%>', '<%=Resources.labels.Accountnotsame%>','<%=lblTextError.ClientID%>')) {
                    document.getElementById('<%=ddlReceiverAccount.ClientID %>').focus();
                    return false;
                }
