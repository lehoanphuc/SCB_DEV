<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_IBCorpRole_Controls_Widget" %>
...
<asp:Panel runat="server" ID="pnFocus" DefaultButton="btnSave1">
<table id="pageadd" cellspacing="1">
    <tr>
        <td class="tdleft">
            <asp:Label ID="Label14" runat="server" SkinID="lblImportant" 
                Text="<%$ Resources:labels, service %>"></asp:Label>
        </td>
        <td>
            <asp:DropDownList ID="ddlService" runat="server" SkinID="extDDL1">
            </asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td class="tdleft">
            ...
            :</td>
        <td>
            <asp:TextBox ID="txtRoleName" runat="server" SkinID="txtTwoColumn" 
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtRoleDescription" runat="server" TextMode="MultiLine" 
                Height="58px" SkinID="txtTwoColumn" Width="300px"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
