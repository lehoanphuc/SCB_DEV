...
public partial class Widgets_ResetPassword_Widget :WidgetBase
{
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        {
            SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["sqlec"], "Widgets_ResetPassword_Widget", "btnLogin_Click", sex.Message, Request.Url.Query);
            SmartPortal.Common.Log.GoToErrorPage(System.Configuration.ConfigurationManager.AppSettings["sqlec"], Request.Url.Query);
        }
        catch (Exception ex)
        {
            SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["sysec"], "Widgets_ResetPassword_Widget", "btnLogin_Click", ex.Message, Request.Url.Query);
