...
public partial class Widgets_Language_Controls_Widget : WidgetBase
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (SmartPortal.Common.Encrypt.GetURLParam(System.Web.HttpContext.Current.Request.RawUrl)["lid"] == null)
        {
            ...
            {
                SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["tiec"], "Widgets_Theme_Controls_Widget", "btnSave_Click", bex.Message, Request.Url.Query);
        ...
        else
        {
            ...
            {
                SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["tuec"], "Widgets_Theme_Controls_Widget", "btnSave_Click", bex.Message, Request.Url.Query);
