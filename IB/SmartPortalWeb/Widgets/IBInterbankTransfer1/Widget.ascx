...
<div class="th">
    <span> <%=Resources.labels.interbanktranferlb %></span><br />
        ...
        <asp:Panel ID="pnTIB" runat="server" class="divcontent">
            ...
            <div class="content_table">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-7 col-md-4 line30">
                        ...
                        <asp:DropDownList ID="ddlSenderCCY" runat="server" Visible="false">
                        </asp:DropDownList>
            ...
            <div class="content_table">
                <div class="row">
                    ...
                    <div class="col-xs-7 col-md-4 line30">
                        <asp:DropDownList ID="ddlReceiverBank" OnSelectedIndexChanged="ddlReceiverBank_SelectedIndexChanged" AutoPostBack="true" runat="server">
                            <asp:ListItem Text="INDOCHINA BANK" Value="00100063"></asp:ListItem>
                        </asp:DropDownList>
                ...
                <div class="row">
                    <div class="col-xs-5 col-md-4 right">
                        <asp:Label ID="Label37" runat="server" Text='<%$ Resources:labels, tennguoithuhuong %>'></asp:Label>&nbsp;*
                    </div>
                    <div class="col-xs-7 col-md-4 line30">
                        <asp:TextBox ID="txtReceiverName" runat="server" onkeyup="this.value=this.value.replace(/[^a-zA-Z ]/g , '')" placeholder="<%$ Resources:labels, notifileReceivername %>"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-5 col-md-4 right">
                    ...
                    <div class="col-xs-7 col-md-4 line30">
                        <asp:TextBox ID="txtReceiverAccount" runat="server" onkeypress="return isNumberKeyNumer(event)" placeholder="<%$ Resources:labels, notifileReceiveraccount %>"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="content_table">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-7 col-sm-4 line30">
                        <asp:TextBox ID="txtDesc"  runat="server" Height="50px" TextMode="MultiLine" onkeyDown="ValidateLimit(this,200);" onpaste="ValidateLimit(this,200);" onkeyup="this.value=this.value.replace(/[^a-zA-Z ]/g , '')"></asp:TextBox><br />
                ...
                <div class="row">
                    <%--                <div id="trNote" class="row" runat="server" visible="True">
                    <div class="col-xs-5 col-md-4 right">
                        <asp:Label ID="Label42" runat="server" Text='<%$ Resources:labels, ghichu %>'></asp:Label>
                    </div>
                    <div class="col-xs-7 col-md-4">
                        <asp:Label ID="Label100" runat="server" Text='<%$ Resources:labels, ghichu2 %>'></asp:Label>
                    </div>
                </div>--%>
                </div>

                <div class="content_table" runat="server" visible="false">
                    <div class="row">
                        <div class="col-xs-5 col-md-4 right">
                ...
                <div style="text-align: center; margin-top: 10px;">
                    <asp:Button ID="btnTIBNext" runat="server" OnClientClick="return validate();" Text='<%$ Resources:labels, tieptuc %>'
                        OnClick="btnTIBNext_Click" class="btn btn-primary" />
                </div>
        </asp:Panel>
...
<script type="text/javascript">
    ...
    function poponload() {
        testwindow = window.open("widgets/IBInterbankTransfer1/print.aspx?cul=" + '<%=System.Globalization.CultureInfo.CurrentCulture.ToString()%>', "BienLai",
            "menubar=1,scrollbars=1,width=500,height=650");
        testwindow.moveTo(0, 0);
        return false;
    }
    function poponloadview() {
        testwindow = window.open("widgets/IBInterbankTransfer1/viewprint.aspx?cul=" + '<%=System.Globalization.CultureInfo.CurrentCulture.ToString()%>', "BienLai",
            "menubar=1,scrollbars=1,width=500,height=650");
        testwindow.moveTo(0, 0);
        return false;
    }
    function validate() {
        if (validateEmpty('<%=txtReceiverName.ClientID %>', '<%=Resources.labels.bancannhaptennguoinhan %>', '<%=lblTextError.ClientID %>')) {
            if (validateEmpty('<%=txtReceiverAccount.ClientID %>', '<%=Resources.labels.taikhoandichkhongrong %>', '<%=lblTextError.ClientID %>')) {
