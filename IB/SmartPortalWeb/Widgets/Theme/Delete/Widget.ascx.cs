...
public partial class Widgets_Theme_Delete_Widget : WidgetBase
{
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            SmartPortal.Common.Log.RaiseError(System.Configuration.ConfigurationManager.AppSettings["themedec"], "Widgets_Theme_Delete_Widget", "btnDelete_Click", bex.Message, Request.Url.Query);
