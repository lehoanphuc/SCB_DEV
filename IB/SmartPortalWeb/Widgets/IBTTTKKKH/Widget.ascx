<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_IBTTTKKKH_Widget" %>
<style type="text/css">
    .style11
    {
        width: 100%; 
...
<div class="block1">            	 
                    ...
                    <div class="content">
                        <table class="style11" cellspacing="0" cellpadding="5">
                            ...
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label4" runat="server" Text="Số tài khoản *"></asp:Label>                                    
                                </td>
                                <td >
                                    <asp:TextBox ID="txtCustCode" runat="server"></asp:TextBox>
                                    <asp:Label ID="Label24" Font-Italic="True" runat="server" 
                                        Text=" (Ví dụ: 00009102001)"></asp:Label>
                                </td>                                
                            </tr>
                            <tr>
                                <td class="tibtd">
                    ...
                    <div class="content">
                        <table class="style11" cellspacing="0" cellpadding="5">
                            ...
                            <tr>
                             ...
                             <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label48" runat="server" Text="Số tài khoản"></asp:Label>
                                </td>
                                 <td>
                                     <asp:Label ID="Label49" runat="server" Font-Bold="True" Text="00009102001"></asp:Label>
                                 </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label2" runat="server" Text="Số dư"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label3" runat="server" Text="1.000.000 LAK"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
                            ...
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label40" runat="server" Text="Lãi nhận được"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label41" runat="server" Text="200.000 LAK"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label44" runat="server" Text="<%$ Resources:labels, mota %>"></asp:Label>
                                </td>
                                <td >
                                    <asp:Label ID="Label45" runat="server" 
                                        Text="Tất toán tài khoản tiết kiệm cá nhân"></asp:Label>
                                </td>                                
                            </tr>                           
                        </table>
                    </div>                
...
<asp:Panel ID="pnResultTransaction" runat="server">
 <div class="block1">            	 
                    ...
                    <div class="handle">                    	
                    	Kết quả tất toán tài khoản tiết kiệm không kỳ hạn
                    </div>                    
                    <div class="content">
                        <table class="style11" cellspacing="0" cellpadding="5">
                            <tr>
                            ...
                            <tr>
                             ...
                             <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label7" runat="server" Text="Số tài khoản"></asp:Label>
                                </td>
                                 <td>
                                     <asp:Label ID="Label8" runat="server" Font-Bold="True" Text="00009102001"></asp:Label>
                                 </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label9" runat="server" Text="Số dư"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label10" runat="server" Text="1.000.000 LAK"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label11" runat="server" Text="Lãi suất"></asp:Label>
                                </td>
                                <td >
                                    <asp:Label ID="Label12" runat="server" Text="3% / năm"></asp:Label>
                                </td>                                
                            </tr>                           
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label13" runat="server" Text="Lãi nhận được"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label ID="Label14" runat="server" Text="200.000 LAK"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="tibtd">
...
<script type="text/javascript">
    ...
    function validate()
    {
       if(validateEmpty('<%=txtCustCode.ClientID %>','Bạn cần nhập số tài khoản'))
                {
