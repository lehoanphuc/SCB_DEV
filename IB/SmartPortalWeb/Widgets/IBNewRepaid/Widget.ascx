<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_IBNewRepaid_Widget" %>
...
<!--Transfer In Bank-->
<div class="th">
<span><%=Resources.labels.napmoithetratruocquocte %></span><br />
...
<%--                                &nbsp;<asp:RadioButton ID="radTS1" runat="server" Checked="True" GroupName="TIB" 
                            ...
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label5" runat="server" Text='<%$ Resources:labels, sothanhtoan %>'></asp:Label>&nbsp;*
                                </td>
                                <td >
                                         <asp:TextBox ID="txtPaymentNo" runat="server" MaxLength="15" ></asp:TextBox>
                                </td>                                
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label1" runat="server" Text='<%$ Resources:labels, tenchuthe %>'></asp:Label>&nbsp;*
                                </td>
 ...
 <div class="block1">            	 
                    ...
                    <div class="content">
                        <table class="style1" cellspacing="0" cellpadding="5">
                            ...
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label21" runat="server" Text="<%$ Resources:labels, sothanhtoan %>"></asp:Label>
                                </td>
                                <td >
                            ...
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label11" runat="server" Text="<%$ Resources:labels, tenchuthe %>"></asp:Label>
                                </td>
                                <td >
                    ...
                    <div class="content">
                        <table class="style1" cellspacing="0" cellpadding="5">
                            ...
                            <tr>
                             ...
                             <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label29" runat="server" Text='<%$ Resources:labels, sothanhtoan %>'></asp:Label>
                                </td>
                                <td >
                                    <asp:Label ID="lblPaymentNoEnd" runat="server"></asp:Label>
                                </td>                               
                            </tr>
                            <tr>
                                <td class="tibtd">
                                    <asp:Label ID="Label27" runat="server" Text='<%$ Resources:labels, tenchuthe %>'></asp:Label>
                                </td>
                                <td >
...
<script type="text/javascript">
    function poponload()
    {
        testwindow = window.open("widgets/IBNewRepaid/print.aspx?cul=" + '<%=System.Globalization.CultureInfo.CurrentCulture.ToString()%>', "BienLai",
    ...
    {
        testwindow = window.open("widgets/IBNewRepaid/viewprint.aspx?cul=" + '<%=System.Globalization.CultureInfo.CurrentCulture.ToString()%>', "BienLai",
        "menubar=1,scrollbars=1,width=500,height=650");
    testwindow.moveTo(0,0);
    return false;
    }
    ...
    function validate()
    {
        if (validateEmpty('<%=txtPaymentNo.ClientID %>', '<%=Resources.labels.sothanhtoankhongrong %>')) {
        if(validateEmpty('<%=txtCardHolder.ClientID %>','<%=Resources.labels.tenchuthethekhongrong %>'))
        {
            ...
            {
                document.getElementById('<%=txtCardHolder.ClientID %>').focus();
                return false;
            }
        } 
        else
