<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Widget.ascx.cs" Inherits="Widgets_IBDept_Delete_Widget" %>
                            ...
                            <tr>
                                <td align="center" class="style2">
                                    <asp:Label ID="Label1" runat="server" 
                                        Text="Bạn chắc chắn muốn xóa phòng ban không?"></asp:Label>
                                </td>
...
&nbsp;
    <asp:Button ID="btback" runat="server" PostBackUrl="javascript:history.go(-1)" 
        Text="Quay lại" />
    &nbsp; &nbsp;
</div>
