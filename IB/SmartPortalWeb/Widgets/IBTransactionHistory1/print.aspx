...
<body>
    <form id="form1" runat="server">
        <div style="padding: 10px;">
            <div>
                <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Logo_of_Siam_Commercial_Bank.svg/1280px-Logo_of_Siam_Commercial_Bank.svg.png' style='height: 70px;' />
            ...
            <div class="content display-label">
                <div class="row text-left">
                    ...
                    <div class="form-group">
                        <label><%=Resources.labels.branch%> : </label>
            ...
            <div>
                <br />
                <p>
                    <a href='https://www.scb.co.th/vn/' target='blank'>scb.co.th.com</a>
                </p>
