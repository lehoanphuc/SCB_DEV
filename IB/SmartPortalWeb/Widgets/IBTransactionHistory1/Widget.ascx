...
<div class="al">
    <%=Resources.labels.chitietgiaodich %><br />
            ...
            <figure>
                ...
                <div class="content_table_4c_cl line30">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-sm-2">
                            <label class="bold">
                                <%= Resources.labels.chinhanhphonggiaodich %>
                            </label>
                        </div>
                        <div class="col-xs-9 col-sm-4">
        ...
        <asp:Panel ID="pnCTGG" runat="server">
            <figure>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnViewHT" runat="server" CssClass="btn btn-primary" Text="<%$ Resources:labels, view %>" OnClick="Button2_Click" />
                    </div>
                </div>
            </figure>
...
<script type="text/javascript">
    ...
    function poponload() {
        testwindow = window.open('widgets/IBTransactionHistory1/print.aspx', "Print",
