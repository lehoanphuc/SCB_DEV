...
<div class="th">
    <span><%=Resources.labels.listwaitingforapprove %></span><br>
            ...
            <asp:Repeater runat="server" ID="rptLTWA" OnItemCommand="gvLTWA_ItemCommand" OnItemDataBound="gvLTWA_OnItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton ID="lbEdit" runat="server" ToolTip="Edit" CommandName='EDIT' CommandArgument='<%#Eval("IPCTRANSID")%>' OnClientClick="Loading();">
                                <span class="fa fa-edit" style="font-size:20px"></span>
                            </asp:LinkButton>
                            <asp:LinkButton ID="lbCancel" runat="server" ToolTip="Cancel" CommandName='<%#IPC.TRANSTATUS.CANCEL %>' CommandArgument='<%#Eval("IPCTRANSID")%>' OnClientClick="Loading();">
                                <span class="fa fa-close" style="padding-left:10px; color:red; font-size:20px"></span>
                            </asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
