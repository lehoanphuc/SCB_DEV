...
public partial class Widgets_IBCashin_print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            tmpl = SmartPortal.Common.ST.GetStringTemplate("IBCashin", "Cashinsuccessfully");
            ...
            tmpl.SetAttribute("invoiceNumber", hasPrint["invoiceNumber"].ToString());
