...
<div class="row form-group">
    ...
    <div class="col-xs-9">
        <asp:TextBox runat="server" ID="txtSearch" CssClass="form-control" onkeyup="FilterItems(this.value)"></asp:TextBox>
        <asp:DropDownList ID="ddlWidget" runat="server" CssClass="form-control select2" Width="100%">
        </asp:DropDownList>
    </div>
</div>
<div class="row form-group">
...
<div class="row form-group text-center">
    <asp:Button ID="btnAdd" CssClass="btn btn-primary" OnClick="btnAdd_OnClick" Text="Add" runat="server"></asp:Button>
</div>
<script type="text/javascript">
    ...
    function CacheItems() {
        ddlText = new Array();
        ddlValue = new Array();
        ddl = document.getElementById("<%=ddlWidget.ClientID %>");
