...
public partial class Widgets_IBCLGD_print : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            tmpl = SmartPortal.Common.ST.GetStringTemplate("IBCLGD", "BatchTransferen-US");
            ...
            tmpl.SetAttribute("details", Session["details"].ToString());
